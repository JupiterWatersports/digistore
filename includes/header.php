...
<i class="fa fa-phone" style="margin-right:5px;"></i><a href="tel:15614270240">+1-561-427-0240</a> &nbsp;<i class="fas fa-sms red-color" style="font-size:24px;"></i><a href="tel:15616770323"></a><B>Text</B> +1-561-677-0323</a></div>
<div class="col-sm-4" style="text-align:center;">
<a href="http://www.jupiterkiteboarding.com/store/pages.php?page=shipping"><b>Free Shipping</b> on orders over $99* </a>
</div>
<div class="col-sm-4" style="text-align:center;">
...
<div id="search" class="col-sm-4">
	<div id="search-block">
<form name="quick_find" action="https://www.jupiterkiteboarding.com/store/advanced_search_result.php" method="get" id="quickfind">
...
<ul>
<li id="myaccount">
<i class="fa fa-user-circle-o" style="margin-right:5px; color:#fff; font-size:18px;"></i><a href="<?php echo tep_href_link('store/account_edit', '', 'SSL'); ?>" class="drop">Account</a>
...
<hr>
<ul>
	<li><a href="<?php echo tep_href_link('store/account_edit','', 'SSL'); ?> ">Account Info</a></li>
	<li><a href="<?php echo tep_href_link('store/account_history','', 'SSL'); ?>">Order History</a></li>
</ul>
</div>
</li>
<li id="blog2" style="display:none;"><a href="<?php echo tep_href_link('store/blog/') ?>" >Blog</a></li>

<li id="reviews"><a href="<?php echo tep_href_link('store/contact-us') ?>" >Contact Us</a></li>
<li id="cart" >
...
@media(max-width:919px) {
	...
	#lower{background: rgba(58, 60, 65, 1); height:70px;}
