...
// define the filenames used in the project
  ...
  define('FILENAME_CONTACT_US', 'contact-us.php');
  ...
  define('FILENAME_PRODUCT_PRINT', 'product_print.php');
...
// recently_viewed
  define('FILENAME_RECENTLY_VIEWED', 'recently_viewed.php');
...
define('FILENAME_MATCHING_PRODUCTS_MANUFACTURERS', 'matching_products_manufacturers.php');
// Nav Bar Begin
define('FILENAME_EXTRAHEADER', 'extraheader.php');
// Nav Bar End
...
define('FILENAME_SEARCHES', 'searches.php');
