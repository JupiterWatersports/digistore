...
require(DIR_WS_INCLUDES . 'ajax.js.php'); 
 ...
 require(DIR_WS_INCLUDES . 'template-top-simple.php'); ?>
...
<div class="grid_4 alpha checkout">
 	<div class="checkout-heading">
 		<?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?>
 	</div>
	<p><?php echo TEXT_SELECTED_PAYMENT_DESTINATION; ?></p>
	<div class="leftfloat"><?php echo tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif','','','','alignleft'); ?></div>
	<div class="leftfloat"><?php echo tep_address_label($customer_id, $billto, true, ' ', '<br />'); ?></div>
	<div class="clear spacer-tall"></div>                    
</div>
<!-- <div class="grid_4 alpha checkout">	
<div class="checkout-heading">Put Something Here</div>
<div class="spacer-tall"></div>
<p class="info">put something here. This CSS class="info"</p>
<p class="notes">put something here. This CSS class="notes"</p>
...
<?php
    ...
    // row content
	// echo $addresses['firstname'] . ' ' . $addresses['lastname']; 	
	echo '<div class="leftfloat">'.tep_address_format($format_id, $addresses, true, ' <br /> ', ', ').'</div>'; 
	echo '<div class="rightfloat">'.tep_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $billto),'class="rightmargin"').'</div>';                 
    $radio_buttons++;
...
<div class="checkout-new-shippadd">
 	<div class="checkout-heading">
...
<div class="alpha checkout">
	<div class="checkout-heading">
		<?php echo TITLE_CONTINUE_CHECKOUT_PROCEDURE;?> </div>
...
<?php
  if ($process == true) {
?>
      <div class="rightfloat"><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '">' . tep_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></div>
