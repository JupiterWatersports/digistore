      ...
      if (MODULE_PAYMENT_PSIGATE_INPUT_MODE == 'Local') {
        ...
        $selection = array('id' => $this->code,
                           ...
                           'fields' => array(array('title' => MODULE_PAYMENT_PSIGATE_TEXT_CREDIT_CARD_OWNER,
                                                   'field' =>  '<br />' . $order->billing['firstname'] . ' ' . $order->billing['lastname'] . '<br /><br />'),
                                             array('title' => MODULE_PAYMENT_PSIGATE_TEXT_CREDIT_CARD_NUMBER,
                                                   'field' => tep_draw_input_field('psigate_cc_number', '', 'data-theme="a"')),
                                             array('title' => MODULE_PAYMENT_PSIGATE_TEXT_CREDIT_CARD_EXPIRES,
                                                   'field' => tep_draw_pull_down_menu('psigate_cc_expires_month', $expires_month, '', 'data-theme="a"') . '&nbsp;' . tep_draw_pull_down_menu('psigate_cc_expires_year', $expires_year, '', 'data-theme="a"'))));
      } else {
        $selection = array('id' => $this->code,
                           'module' => $this->title);
      }
