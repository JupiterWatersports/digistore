    ...
    function selection() {
      ...
      if (MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_INPUT_PAGE == 'Payment') {
        ...
        $selection['fields'] = array(array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_OWNER,
                                           'field' => tep_draw_input_field('cc_owner', $order->billing['firstname'] . ' ' . $order->billing['lastname'], 'data-theme="a"')),
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_TYPE,
                                           'field' => tep_draw_pull_down_menu('cc_type', $types_array, 'data-theme="a"')),
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_NUMBER,
                                           'field' => tep_draw_input_field('cc_number_nh-dns', '', 'data-theme="a"')),
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_VALID_FROM,
                                           'field' => tep_draw_pull_down_menu('cc_starts_month', $months_array, 'data-theme="a"') . '&nbsp;' . tep_draw_pull_down_menu('cc_starts_year', $year_valid_from_array) . ' ' . MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_VALID_FROM_INFO, 'data-theme="a"'),
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_EXPIRES,
                                           'field' => tep_draw_pull_down_menu('cc_expires_month', $months_array, 'data-theme="a"') . '&nbsp;' . tep_draw_pull_down_menu('cc_expires_year', $year_expires_array, 'data-theme="a"')),
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_CVC,
                                           'field' => tep_draw_input_field('cc_cvc_nh-dns', '', 'size="5" maxlength="4" data-theme="a"')));
        ...
        if ( $this->isCardAccepted('SWITCH') || $this->isCardAccepted('SOLO') ) {
          $selection['fields'][] = array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_ISSUE_NUMBER,
                                         'field' => tep_draw_input_field('cc_issue_nh-dns', '', 'size="3" maxlength="2" data-theme="a"') . ' ' . MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_ISSUE_NUMBER_INFO);
        }
      }
      ...
      if (MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_INPUT_PAGE == 'Payment') {
        ...
        $confirmation['fields'] = array(array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_OWNER,
                                        ...
                                        array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_NUMBER,
                                              'field' => tep_draw_input_field('cc_number_nh-dns', '', 'data-theme="a"')),
                                        array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_VALID_FROM,
                                              'field' => tep_draw_pull_down_menu('cc_starts_month', $months_array, '', 'data-theme="a"') . '&nbsp;' . tep_draw_pull_down_menu('cc_starts_year', $year_valid_from_array, '', 'data-theme="a"') . ' ' . MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_VALID_FROM_INFO),
                                        array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_EXPIRES,
                                              'field' => tep_draw_pull_down_menu('cc_expires_month', $months_array) . '&nbsp;' . tep_draw_pull_down_menu('cc_expires_year', $year_expires_array, '', 'data-theme="a"')),
                                        array('title' => MODULE_PAYMENT_PAYPAL_PRO_DP_CARD_CVC,
                                              'field' => tep_draw_input_field('cc_cvc_nh-dns', '', 'size="5" maxlength="4" data-theme="a"')));
