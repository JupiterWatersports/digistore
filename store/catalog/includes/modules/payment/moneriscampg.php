...
*/
  ...
  class moneriscampg {
    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
                         ...
                         'fields' => array(
                                           ...
                                           array('title' => MODULE_PAYMENT_MONERISCAMPG_TEXT_CREDIT_CARD_OWNER,
                                                 'field' => tep_draw_input_field('campg_cc_name', $order->billing['firstname'] . ' ' . $order->billing['lastname'], 'data-theme="a"')
                                                ),
                                           array('title' => MODULE_PAYMENT_MONERISCAMPG_TEXT_CREDIT_CARD_NUMBER,
                                                 'field' => tep_draw_input_field('campg_cc_number', '', 'data-theme="a"')
                                                ),
                                           array('title' => MODULE_PAYMENT_MONERISCAMPG_TEXT_CREDIT_CARD_EXPIRES,
                                                 'field' => tep_draw_pull_down_menu('campg_cc_expires_month', $expires_month, '', 'data-theme="a"') . '&nbsp;' . tep_draw_pull_down_menu('campg_cc_expires_year', $expires_year, '', 'data-theme="a"')
                                                )
                                          )
                        );
      ...
      if ($this->cvd) {
        ...
        $cvd_selection = array (
                                ...
                                'field' => tep_draw_input_field('campg_cvd', '', 'size="3" maxlength="4" data-theme="a"') . ' ' .'<a href="javascript:popupWindow(\'' . tep_href_link(FILENAME_POPUP_CVV, '', 'SSL') . '\')">' . TEXT_CVV_LINK . '</a>'
                               );
    ...
    function before_process() {
	  ...
	  $this->host=(MODULE_PAYMENT_MONERISCAMPG_ENV == "Production Server" ? "www3dr.moneris.com" : "esqa.moneris.com");
