    ...
    function selection() {
      ...
      if (MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_INPUT_PAGE == 'Payment') {
        ...
        $selection['fields'] = array(array('title' => MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_OWNER_FIRSTNAME,
                                           'field' => tep_draw_input_field('cc_owner_firstname', $order->billing['firstname'], 'data-theme="a"')),
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_OWNER_LASTNAME,
                                           'field' => tep_draw_input_field('cc_owner_lastname', $order->billing['lastname'], 'data-theme="a"')),
                                     ...
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_VALID_FROM,
                                           'field' => tep_draw_pull_down_menu('cc_starts_month', $months_array, '', 'data-theme="a"') . '&nbsp;' . tep_draw_pull_down_menu('cc_starts_year', $year_valid_from_array, '', 'data-theme="a"') . ' ' . MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_VALID_FROM_INFO),
                                     ...
                                     array('title' => MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_ISSUE_NUMBER,
                                           'field' => tep_draw_input_field('cc_issue_nh-dns', '', 'size="3" maxlength="2" data-theme="a"') . ' ' . MODULE_PAYMENT_PAYPAL_PRO_PAYFLOW_DP_CARD_ISSUE_NUMBER_INFO));
      }
