...
?>
				  ...
				  <?php echo tep_input_jquery('dob', tep_date_short($account['customers_dob']));
  }
?>
				  <br />
                  <label for="email_address" ><?php echo ENTRY_EMAIL_ADDRESS; ?></label>
				  <?php echo tep_input_jquery('email_address', $account['customers_email_address']); ?>
				  <br />
                  <label for="telephone" ><?php echo ENTRY_TELEPHONE_NUMBER; ?></label>
				  <?php echo tep_input_jquery('telephone', $account['customers_telephone']); ?>
				  <br />
		  <label for="fax" ><?php echo ENTRY_FAX_NUMBER; ?></label>
				  <?php echo tep_input_jquery('fax', $account['customers_fax']); ?>

<br/>
	<div class="bouton">
	<?php 
	echo tep_button_jquery(IMAGE_BUTTON_BACK,tep_mobile_link(FILENAME_ACCOUNT, '', 'SSL'),'b','button',' data-inline="true" data-icon="back" ') .
	tep_button_jquery(IMAGE_BUTTON_CONTINUE,'','b','submit',' data-inline="true" data-icon="check"  ');
	?>
	</div>
