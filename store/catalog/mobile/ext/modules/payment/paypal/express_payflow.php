...
// if there is nothing in the customers cart, redirect them to the shopping cart page
  ...
  require(DIR_WS_INCLUDES . 'modules/payment/paypal_pro_payflow_ec.php');
...
// select cheapest shipping method
          ...
          tep_redirect(tep_mobile_link(FILENAME_CHECKOUT_CONFIRMATION, '', 'SSL'));
        } else {
          if (!tep_session_is_registered('shipping')) tep_session_register('shipping');
          $shipping = false;
        ...
        tep_redirect(tep_mobile_link(FILENAME_SHOPPING_CART, 'error_message=' . urlencode($error_message), 'SSL'));
      }
    ...
    default:
      ...
      $params['RETURNURL'] = tep_mobile_link('ext/modules/payment/paypal/express_payflow.php', 'osC_Action=retrieve', 'SSL', true, false);
      $params['CANCELURL'] = tep_mobile_link(FILENAME_SHOPPING_CART, '', 'SSL', true, false);
  ...
  tep_redirect(tep_mobile_link(FILENAME_SHOPPING_CART, '', 'SSL'));

  require(DIR_MOBILE_INCLUDES . 'application_bottom.php');
?>
