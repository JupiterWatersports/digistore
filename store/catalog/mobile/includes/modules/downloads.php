...
// - The expiry date is not reached
 	...
 	echo  $downloads['products_name'] . ' &nbsp;&nbsp; ' . tep_button_jquery(IMAGE_BUTTON_DOWNLOAD , tep_mobile_link(FILENAME_DOWNLOAD, 'order=' . $last_order . '&id=' . $downloads['orders_products_download_id']), 'b' , 'button' , 'data-icon="arrow-d" data-iconpos="right" data-inline="true" data-ajax="false"' );
      } else {
        echo ' &nbsp;-&nbsp; ' . $downloads['products_name'];
      }
      echo ' &nbsp;&nbsp; ' . TABLE_HEADING_DOWNLOAD_DATE . tep_date_long($download_expiry) . 
           ' &nbsp;-&nbsp; ' . $downloads['download_count'] . TABLE_HEADING_DOWNLOAD_COUNT . '<br>';
    }
?>
...
?>
    ...
    <?php printf(FOOTER_DOWNLOAD, tep_button_jquery(IMAGE_BUTTON_ACCOUNT , tep_mobile_link(FILENAME_ACCOUNT, '', 'SSL'), 'b' , 'button' , 'data-icon="home" data-iconpos="right" data-inline="true"' )); ?>
