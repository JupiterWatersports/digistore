...
?>
		<div id="ficheProdTop">
				...
				if (tep_not_null($product_info['products_image'])) {
					echo '<div class="visuel">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], MOBILE_PRODUCT_IMAGE_WIDTH, MOBILE_PRODUCT_IMAGE_HEIGHT, 'style="max-width:100%; max-height:100%"') . '</div>';
				}
				?>
			...
			<div class="bouton">
				<?php echo tep_draw_hidden_field('products_id', $product_info['products_id']) . '
        				   <input value="'.IMAGE_BUTTON_IN_CART.'" type="submit" name="cart" data-role="submit"  data-icon="plus" data-iconpos="right" data-theme="b">';?>
			</div>
</div>
</form>
