...
require_once('includes/application_top.php');
  ...
  $listing_sql .= " order by p.products_date_added DESC, pd.products_name";	
    ...
    $classic_site = HTTP_SERVER . DIR_WS_HTTP_CATALOG . FILENAME_PRODUCTS_NEW . (tep_not_null(tep_get_all_get_params())? '?' . tep_get_all_get_params(): '');
...
echo tep_button_jquery(IMAGE_BUTTON_BACK,tep_mobile_link(FILENAME_CATALOG_MB),'a','button','');
