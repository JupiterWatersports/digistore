...
<div id="cms">
	...
	<div id="bouton">
	<?php echo tep_button_jquery(IMAGE_BUTTON_BACK, tep_mobile_link(FILENAME_ADDRESS_BOOK, '', 'SSL'), 'b', 'button', 'data-icon="back" data-inline="true" data-ajax="false"') . 
		   tep_button_jquery(IMAGE_BUTTON_DELETE, tep_mobile_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $HTTP_GET_VARS['delete'] . '&action=deleteconfirm&formid=' . md5($sessiontoken), 'SSL'), 'b', 'button', 'data-icon="delete" data-iconpos="right" data-inline="true"'); ?>
	</div>
</div>	  
<?php
  } else {

	include(DIR_MOBILE_MODULES . 'address_book_details.php');
...
<br/>
	...
	<?php 
		...
		tep_draw_hidden_field('edit', $HTTP_GET_VARS['edit']) .
		tep_button_jquery(IMAGE_BUTTON_BACK,tep_mobile_link(FILENAME_ADDRESS_BOOK, '', 'SSL'), 'b', 'button', 'data-icon="back" data-inline="true"') .
		tep_button_jquery(IMAGE_BUTTON_CONTINUE, '', 'b', 'submit', 'data-icon="arrow-r" data-iconpos="right" data-inline="true" ');
		?>  
	</div>
<?php
    } else {
...
<?php 
	...
	tep_button_jquery(IMAGE_BUTTON_BACK, tep_mobile_link(FILENAME_ADDRESS_BOOK, '', 'SSL'), 'b', 'button', ' data-inline="true" data-icon="back"') .
	tep_button_jquery(IMAGE_BUTTON_CONTINUE, '', 'b', 'submit','data-icon="arrow-r" data-iconpos="right" data-inline="true"');
?>  
	</div>
