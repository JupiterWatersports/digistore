  ...
  <tr>
    <td>
      ...
      <div align=\"center\">
        ...
        <?php
        $temp_lang=ucfirst(substr($defaultValuesAsArray[9],0,strpos($defaultValuesAsArray[9],'.')));
 		echo "<option selected value='$defaultValuesAsArray[9]'>$temp_lang</option>";
        $handle = opendir('../language');
        	while (false !== ($file = readdir($handle))) 
 			{ 
    			if ($file {0}!='.' && $file!=$defaultValuesAsArray[9]) 
 				{ 
...
function updateSettings($companyname,$companyaddress,$companyphone,$companyemail,$companyfax,$companywebsite,$companyother,$theme,$taxrate,$currencySymbol,$language) {
...
\$cfg_osc_server=\"$cfg_osc_server\";
\$cfg_osc_database=\"$cfg_osc_database\";
\$cfg_osc_username=\"$cfg_osc_username\";
\$cfg_osc_password=\"$cfg_osc_password\";
...
$hDisplay=new display($dbf->conn,$dbf_osc->conn,$cfg_theme,$cfg_currency_symbol,$lang);
...
if(isset($_POST['submitChanges'])) {
	if($_POST['companyName']!="" && $_POST['companyPhone']!="" && $_POST['taxRate']!="" && $_POST['currencySymbol']!="") 
	{
		...
		updateSettings($_POST['companyName'],$_POST['companyAddress'],$_POST['companyPhone'],
			$_POST['companyEmail'],$_POST['companyFax'],$_POST['companyWebsite'],$_POST['companyOther'],$_POST['themeSelected'],$_POST['taxRate'],$_POST['currencySymbol'],$_POST['language']);
