...
$display=new display($dbf->conn,$dbf_osc->conn,$cfg_theme,$cfg_currency_symbol,$lang);$display->displayTitle("$cfg_company $lang->allItemsReport");
$tableheaders=array("$lang->itemName","$lang->numberPurchased","$lang->subTotalForItem","$lang->totalForItem");
