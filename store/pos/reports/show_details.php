...
$display=new display($dbf->conn,$dbf_osc->conn,$cfg_theme,$cfg_currency_symbol,$lang);$display->displayTitle("$lang->saleDetails");
$tableheaders=array("$lang->rowID","$lang->itemName","$lang->quantityPurchased","$lang->unitPrice","$lang->totalItemCost");
$tablefields=array('id','item_id','quantity_purchased','item_unit_price','item_total_cost');
