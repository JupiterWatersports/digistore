...
$id=-1;
	...
	if(isset($_POST['date']) and isset($_POST['paid_with']) and isset($_POST['id']))
	{
	...
	$field_names=array('date','paid_with','comment');
	$field_data=array("$date","$paid_with","$comment");
