...
class language
{
	...
	/*Items Home Start*/
    var $itemsWelcomeScreen='Bienvenido a la pantalla de Artículos.';
	...
	/*Config Start*/
	var $configurationWelcomeMessage='Bienvendio!&nbsp; Esta es la pantalla de Configuración de PHP Punto de Venta.&nbsp; 
Aqui puedes modificar informacion de la empresa, temas, y otras opciones.&nbsp;Campos en negrita son requeridos.';
	...
	var $upgradeMessage='Presionar ENVIAR para actualizar la base de datos a version  8.0.  Tienes que tener la version 7.0 o más nueva para actualizar Punto de Venta PHP.';
	var $upgradeSuccessfullMessage='La base de datos de Punto de Venta PHP ha sido actualizada con exito a la  version 8.0, favor de borrar los directorios de upgrade y install para tu seguridad.';
