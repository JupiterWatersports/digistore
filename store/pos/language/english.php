...
class language
{
	...
	/*Items Home Start*/
    var $itemsWelcomeScreen='Welcome to the Items panel.&nbsp; Here you view your items.';
	...
	var $upgradeMessage='Clicking submit will upgrade the database to version 8.0.  You must have version 7.0 or greater to upgrade PHP Point Of Sale.';
	var $upgradeSuccessfullMessage='PHP Point Of Sale\'s database has been successfully upgraded to version 8.0, please delete the upgrade and install folders for security purposes.';
