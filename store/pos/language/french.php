...
class language
{
	...
	/*Items Home Start*/
    var $itemsWelcomeScreen='Bienvenue sur la page de gestion des articles.';
	...
	var $upgradeMessage='Si vous cliquez sur [valider], la base de données sera mise à jour pour la version 8.0.  Vous devez avoir la version 7.0 au minimum pour faire la mise à jour de PHP Point Of Sale.';
	var $upgradeSuccessfullMessage='La base de données de PHP Point Of Sale a été correctement mise à jour pour la version 8.0. Effacez le réperoire de mise à jour et d\'installation pour des question de sécurité.';
