 ...
 */	
	function GoogleSitemap($host, $user, $db, $pass){
		...
		if (($pos = strpos(DIR_FS_CATALOG, "googlesitemap")) !== FALSE)   //fix for when path is gotten by dirname($HTTP_SERVER_VARS['SCRIPT_
 ...
 */	
    ...
    $filename = "jupiterk/filemanager/domains/jupiterkiteboarding.com/public_html/store". $this->savepath . $this->filename . $type;
