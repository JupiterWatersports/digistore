...
<link rel="alternate" media="only screen and (max-width: 640px)" href="http://jupiterkiteboarding.com/store/mobile_shopping_cart.php" >
</head>
...
<?php
    ...
    $info_box_contents[0][] = array('align' => 'left',
                                    ...
                                    'params' => 'style="padding-left:25px; font-family: Verdana, Arial, sans-serif; color:#666; font-weight: bold; font-size:10px;"',
    ...
    $info_box_contents[0][] = array('align' => 'center',
									...
									'params' => 'style="padding-left:20px; font-family: Verdana, Arial, sans-serif; color:#666; font-weight: bold; font-size:10px;"',
    ...
    $info_box_contents[0][] = array('align' => 'center',
                                    ...
                                    'params' => 'style="font-family: Verdana, Arial, sans-serif; color:#666; font-weight: bold; font-size:10px;"',
...
// Push all attributes information in an array
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      ...
      $info_box_contents[$cur_row][] = array('align' => 'center',
                                             ...
                                             'text' => tep_draw_checkbox_field('cart_delete[]', $products[$i]['id']). ' Remove');
