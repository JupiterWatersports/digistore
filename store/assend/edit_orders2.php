...
<!-- header_eof //-->
 ...
 ?>
         ...
         <div id="heading-block" class="col-xs-12">
     <div class="row">
		  <div class="col-xl">
          <div class="pageHeading form-group"><?php echo sprintf(HEADING_TITLE, $oID, tep_date_short($order->info['date_purchased'])); ?></div>
          <div class="col-xxxxs"><span style="display:inline-block;">Order Entered By:</span><?php echo tep_draw_pull_down_menu('update_customer_service_id',  $user_names, $order->info['customer_service_id'], 'class="form-control"  style= "width:120px; display:inline-block;" onChange="updateOrdersField(\'customer_service_id\', this.options[this.selectedIndex].text);"'); ?> </div></div>
          <ul class="edit-orders-heading-links col-sm-7">
			  
			<li><?php echo '<a class="btns" style="width:100px; display:inline-block; height:25px;" href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']. '&action=email') . '" TARGET="_blank"><i class="fa fa-envelope-o" style="margin-right:5px;"></i>Send Invoice</a>'; ?></li>
		    <li><?php echo '<a class="btns" style="width:100px; display:inline-block; height:25px;" href="' . tep_href_link(FILENAME_ORDERS, 'oID=' . $_GET['oID'] . '&action=edit') . '" TARGET="_blank"><i class="fa fa-eye" style="margin-right:5px;"></i>Details</a>'; ?></li>
		  <li><?php echo '<a class="btns" style="width:100px; display:inline-block; height:25px;" href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']) . '" TARGET="_blank"><i class="fa fa-file-text-o" style="margin-right:5px;"></i>Invoice</a>'; ?></li>
           <li><?php echo '<a class="btns" style="width:100px; display:inline-block; height:25px;" href="' . tep_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">Packing Slip</a>'; ?></li>
            <li><?php echo '<a style="width:100px; display:inline-block; height:25px; vertical-align:middle;" href="' . tep_href_link(FILENAME_ORDERS_FEDEX_SHIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . tep_image_button('button_fedex_shipping.gif', 'Ship with Fedex') . '</a>'; ?></li>
             <li ><?php echo '<a style="width:100px; display:inline-block; height:25px; vertical-align:middle;" href="' . tep_href_link(FILENAME_ORDERS_USPS_SHIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . tep_image_button('button_labelshipping.gif', IMAGE_ORDERS_USPS_SHIP) . '</a>'; ?></li>
		    <li><?php echo '<a class="btns" style="width:100px; display:inline-block; height:25px;" href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('action'))) . '"><i class="fa fa-chevron-left" style="margin-right:5px;"></i>Go Back</a> '; ?></li>
		  </ul>
...
<div style="margin:10px 0px 25px;" class="col-xs-12">
		<label><input type="checkbox" <?php if(isset($_SESSION['disable_slow_shipping'])&&$_SESSION['disable_slow_shipping']) echo ' checked '; ?> onClick="disableSlowShipping(this.checked);" /> Disable shipping modules</label>
	</div>
...
<div id="tab-container" class="tab-container">
  <ul class="tabs">
<li ><a href="#tab1"><?php echo 'Products' ?></a></li>
<li ><a href="#tab2"><?php echo 'Customer Details/ CC Info' ?></a></li>
 </ul>
...
<div id="tab2">
  ...
  <div id="customer-info-wrapper">  
            ...
            <label class="col-sm-5 control-label"><?php echo 'ZIP'; ?></label>
               <div class="col-sm-7"><input class="form-control" name="update_customer_postcode" size="5" value="<?php echo $order->customer['postcode']; ?>" <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>onChange="updateOrdersField('customers_postcode', encodeURIComponent(this.value))"<?php } ?>></div></div>
            ...
            <label class="col-sm-4 control-label"><?php echo ENTRY_TELEPHONE_NUMBER; ?></label>
            ...
            <label for="sa-2"  class="shipping-add-heading"><?php echo ENTRY_SHIPPING_ADDRESS; ?><i class="fa fa-caret-down" style="margin-left:5px;"></i><i class="fa fa-caret-up" style="margin-left:5px;"></i></label> 
				...
				echo tep_draw_pull_down_menu('update_delivery_zone_id', tep_get_country_zones($order->delivery['country_id']), $order->delivery['zone_id'], 'class="col-sm-9 form-control" onChange="updateShippingZone(\'delivery_state\', this.options[this.selectedIndex].text);"'); 
                  ...
                  <div class="form-group col-xs-12 col-sm-5" style="padding:0px;">
            <label class="col-sm-5 control-label"><?php echo 'ZIP'; ?></label>
               <div class="col-sm-7"><input class="form-control" name="update_delivery_postcode" size="5" value="<?php echo $order->delivery['postcode']; ?>" <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>onChange="updateShippingZone('delivery_postcode', encodeURIComponent(this.value))"<?php } ?>></div>
               </div>
               <div class="form-group col-xs-12 col-sm-7" style="padding:0px;">
                <label class="col-sm-4 control-label"><?php echo ENTRY_COUNTRY; ?></label>
                <div class="col-sm-8">
            ...
            <!-- shipping_address_eof //-->
             ...
             <label for="ba-3" class="billing-add-heading" ><?php echo ENTRY_BILLING_ADDRESS; ?><i class="fa fa-caret-down" style="margin-left:5px;"></i><i class="fa fa-caret-up" style="margin-left:5px;"></i></label>
             <div class="billing-info-inner">
                  ...
                  <div class="form-group col-xs-12 col-sm-6" style="padding:0px;">
                   ...
                   <div class="form-group col-xs-12 col-sm-5" style="padding:0px;">
            <label class="col-sm-5 control-label"><?php echo 'ZIP'; ?></label>
               <div class="col-sm-7"><input class="form-control" name="update_billing_postcode" size="5" value="<?php echo $order->billing['postcode']; ?>" <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>onChange="updateOrdersField('billing_postcode', encodeURIComponent(this.value))"<?php } ?>></div>
               </div>
                 <div class="form-group col-xs-12 col-sm-7" style="padding:0px;">
                    <label class="col-sm-4 control-label"><?php echo ENTRY_COUNTRY; ?></label>
                <div class="col-sm-8">
...
?>
	     ...
	     <td>
		  <input name="update_info_payment_currency_value" size="15" style="width:50px;" readonly="readonly" id="update_info_payment_currency_value" value="<?php echo $order->info['currency_value']; ?>">
		 </td>
      </tr>
	...
	<td colspan="4" valign="top" class="dataTableContent">
		...
		<script src="jSignature/jSignature.min.js"></script>
			<style>
				...
				#signature{ width:100%; height:160px; border:1px solid #eee;}
...
?>
		   ...
		   <?php if ((!$order->products[$i]['msrp'] == NULL) && (!($order->products[$i]['msrp'] == $order->products[$i]['price'])) && (!($order->products[$i]['msrp'] == 0)) ) {  ?>
           	<td class="dataTableContent msrp" valign="top"><span>MSRP:&nbsp;$<?php echo @number_format($order->products[$i]['msrp'],2,'.',''); ?></span></td>
			...
			<td class="dataTableContent price-excl" valign="top"><input name="<?php echo "update_products[" . $orders_products_id . "][final_price]"; ?>" size="5" onKeyUp="updatePrices('final_price', '<?php echo $orders_products_id; ?>')" <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>onChange="updateProductsField('reload2', '<?php echo $orders_products_id; ?>')"<?php } ?> value="<?php echo @number_format($order->products[$i]['final_price'], 2, '.', ''); ?>" class="price-excl" id="<?php echo "update_products[" . $orders_products_id . "][final_price]"; ?>"></td>
...
function submitstep4(){
 ...
 ?>   
          ...
          <div class="dataTableHeadingContent" style="text-align:center; padding-top:5px;"><?php echo sprintf(ADDING_TITLE, $oID); ?></div>
           ...
           <form method="POST" id="choosecategory">
            <div class="dataTableContent col-addprdct-2"><?php echo TEXT_STEP_1; ?></div>
            <div class="dataTableContent col-addprdct-9" valign="top"><?php echo tep_draw_pull_down_menu('add_product_categories_id', tep_get_category_tree('0', '', '0', $category_array), $add_product_categories_id,'style="" onchange="categoriesChange();"'); ?></div>
...
<div class="col-addprdct-12"><div class="col-addprdct-2">&nbsp;</div><div class="col-addprdct-9" valign="top"><input type="text" id="searchbox" name="product_search" value="<?php if(isset($_POST['product_search'])) echo $_POST['product_search']; ?>" autocomplete="off" onChange="/*this.form.submit();*/" class="upcfield"></div></div>
...
?>
 ...
 <div class="" style="height:29px; background-color: #3D464E;text-align: center; padding: 6px; line-height: 1.428571429; color:#fff;">Payment History</div>
...
<script language="JavaScript" src="includes/javascript/spiffyCal/spiffyCal_v2_1.js"></script>
      <div class="inner-pay-stuff">
      <div class="datepaid-timepaid form-group">
       <div class="col-xs-12 form-group">
      <div style="width:116px; float:left;">Date Paid<br /><small>(YYYY-MM-DD)</small></div>
            <div  style="width:119px; float:left;"> <script language="javascript"><!--
  var datePaid = new ctlSpiffyCalendarBox("datePaid", "edit_order", "date_paid","btnDate1","<?php echo $date_paid==''?date('Y-m-d'):date('Y-m-d',strtotime($date_paid)); ?>",scBTNMODE_CUSTOMBLUE);
//--></script>
          <script language="javascript">datePaid.writeControl(); datePaid.dateFormat="yyyy-MM-dd"; datePaid.JStoRunOnSelect="doUpdateDatePaid();";</script></td>
	</div>
    </div>
     <div class="col-xs-12">
      <div style="width:116px; float:left;">Time Paid<br /><small>(HH:MM:SS)</small></div>
            <div  style="width:119px; float:left;"><input type="time" id="time_paid" class="form-control" value="<?php echo $date_paid==''?date('H:i:s'):date('H:i:s',strtotime($date_paid)); ?>" style="width:90px;" />
	</div>
    </div>
    
    </div>
    
    <div class="amount-chargedpaid">
         <?php
		    $total_paid_query = tep_db_query("select SUM(payment_value) 
                                            FROM " . TABLE_ORDERS_PAYMENT_HISTORY . " 
									        WHERE orders_id = '" . (int)$oID . "' 
									        ");
  ...
  for ($i=0; $i<sizeof($order->totals); $i++) {
    ...
    if ( ($order->totals[$i]['class'] == 'ot_total') /*||  ($order->totals[$i]['class'] == 'ot_loworderfee')*/ ) {
      echo '<div class="col-xs-12 form-group">Amount Charged&nbsp;&nbsp;&nbsp;&nbsp;<input style="width:90px; display:inline-block;" class="form-control" id="paytotalbox" value="'. @number_format($order->totals[$i]['value'], 2,'.','') . '"></input><input name="update_totals_xx['.$i.'][class]" type="hidden" value="' . $order->totals[$i]['class'] . '"></div>';
	  echo '<div class="col-xs-12">Current Total Paid:&nbsp;&nbsp;'.'<div style="width:90px; display:inline-block;">$'.number_format( $total_paid['SUM(payment_value)'], 2,'.','').'</div></div>';
     }
  }
?>
</div>
...
function sendTracking() { //this is used for inserting new commments
	   createRequest();
	   jQuery('select#status').val(112);
	 ...
	 var comments = encodeURIComponent(document.getElementById("comments").value);
	   var url = "<?php echo FILENAME_ORDERS_EDIT_AJAX; ?>?action=tracking_sent&oID=<?php echo $_GET['oID']; ?>&status=" + status +"&notify=" + notify + "&notify_comments=" + notifyComments + "&comments=" + comments;
  ...
  function sendQuote() { //this is used for inserting new commments
	   createRequest();
	   jQuery('select#status').val(122);
	   var notify = document.getElementById("notify").checked;
	   var notifyComments = document.getElementById("notify_comments").checked;
	 var comments = encodeURIComponent(document.getElementById("comments").value);
	   var url = "<?php echo FILENAME_ORDERS_EDIT_AJAX; ?>?action=quote_sent&oID=<?php echo $_GET['oID']; ?>&status=" + status +"&notify=" + notify + "&notify_comments=" + notifyComments + "&comments=" + comments;
		xmlHttp.open("GET", url, true);  
	  xmlHttp.onreadystatechange=
                function(){if(xmlHttp.readyState!=4)return;if(xmlHttp.status==200){reloadDiv('commentsBlock', xmlHttp.responseText);clearComments();}};
	    xmlHttp.send(null);
...
<div class="col-xs-12">&nbsp;</div>
         ...
         <div class="col-xs-3 pymnt-buttons"><button type="button" value="1" onClick="updateOrdersPaymentHistoryField(1)">Paid Credit</button></div>
         <div class="col-xs-3 pymnt-buttons"><button type="button" onClick="updateOrdersPaymentHistoryField(2)">Paid Debit</button></div>
         <div class="col-xs-3 pymnt-buttons"><button type="button" onClick="updateOrdersPaymentHistoryField(3)">Paid Cash</button></div> 
         <div class="col-xs-3 pymnt-buttons"><button type="button" onClick="updateOrdersPaymentHistoryField(4)">Paid Paypal</button></div>
         <div class="col-xs-6 pymnt-buttons" style="margin-top:10px;"><button type="button" onClick="updateOrdersPaymentHistoryField(5)">Refunded</button></div>
         <div class="col-xs-6 pymnt-buttons" style="margin-top:10px;"><button type="button" onClick="updateOrdersPaymentHistoryField(6)">Other</button></div>
   </div>
         </div>
       <?php } ?>  
	   <div id="commentsTable_wrap">
         <table style="border: 1px solid #C9C9C9; width:100%; background-color:transparent;" cellspacing="0" cellpadding="2" class="dataTableRow" id="commentsTable">
         <thead>
     <tr class="dataTableHeadingRow">
      <td class="dataTableHeadingContent" align="left" style="width:10%">Delete?</td>
      <td class="dataTableHeadingContent" align="center" style="width:22%">Date Paid</td>
      <td class="dataTableHeadingContent" align="center" style="width:20%">Payment</td>
       <td class="dataTableHeadingContent" align="center" style="">Amount</td>
      <td class="dataTableHeadingContent" align="center" style="width:30%">Comments</td>
    </tr>
    </thead>
    
     <?php
	 $payment_history_query = tep_db_query("SELECT  orders_payment_history_id, date_paid, payment_type_id, payment_value, payment_comments 
                                            FROM " . TABLE_ORDERS_PAYMENT_HISTORY . " 
									        WHERE orders_id = '" . (int)$oID . "' 
        ...
        if (tep_db_num_rows($payment_history_query)) {
         ...
         '	  <td class="" align="center"><div id="do_not_delete"><input name="update_comments[' . $payment_history['orders_payment_history_id'] . '][delete]" type="checkbox" onClick="deletePaymentHistory( \'' . $payment_history['orders_payment_history_id'] . '\',  this)"></div></td>' . "\n" . 
		
         '    <td class="" align="center">' . tep_datetime_short($payment_history['date_paid']) . '</td>' . "\n";
		 } else {
		 echo '  <tr class="' . $rowClass . '" id="commentRow' . $payment_history['orders_payment_history_id'] . '" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this, \'' . $rowClass . '\')">' . "\n" .
         '	  <td class="" align="center"><div id="do_not_delete"><input name="update_comments[' . $payment_history['orders_payment_history_id'] . '][delete]" type="checkbox"></div></td>' . "\n" . 
         '    <td class="" align="center">' . tep_datetime_short($payment_history['date_paid']) . '</td>' . "\n";
...
<div class="dataTableHeadingRow">
   <div class="" style="height:29px; background-color: #3D464E;text-align: center; padding: 6px; line-height: 1.428571429; color:#fff;"><?php echo 'New Status/ Comments' ?></div>
</div>
		  <div class="newstatus-inner">
           <div class="form-group"><textarea name="comments" cols="40" rows="5" placeholder="Status Comments" class="form-control" id="comments"></textarea></div>

           <div class="new-status-options-submit" style="width:310px; margin:0px auto 17px; display:table;">
...
$("#send-tracking").removeClass('disabled');
          ...
          <div class="main col-xs-5"><b><?php echo ENTRY_STATUS; ?></b></div>
          <div class="main col-xs-5"><?php echo tep_draw_pull_down_menu('status', $orders_statuses, $order->info['orders_status'], 'id="status"'); ?></div>
        </div>
  
         <div class="main col-xs-5"><b><?php echo ENTRY_NOTIFY_CUSTOMER; ?></b></div>
           <div class="main col-xs-5" style="text-align:center;"><?php echo oe_draw_checkbox_field('notify', '', false, '', 'id="notify"'); ?></div>
     
          <div class="main col-xs-5"><b><?php echo ENTRY_NOTIFY_COMMENTS; ?></b></div>
           <div class="main col-xs-5" style="text-align:center;"><?php echo oe_draw_checkbox_field('notify_comments', '', false, '', 'id="notify_comments"'); ?></div>
            <div class="main col-xs-5" style="float:none; margin-bottom:10px;"><?php echo '<a class="btns" style="width:100px; display:inline-block; height:25px;" href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']. '&action=email') . '" TARGET="_blank"><i class="fa fa-envelope-o" style="margin-right:5px;"></i>Send Invoice</a>'; ?></div>
           <div class="main col-xs-5" style="float:none; margin-bottom:10px;"><?php echo '<button class="btns" style="width:100px; display:inline-block; height:25px;" type="button" onClick="sendQuote(122)"><a style="display:block; width:100%; color:#FFF; font-size:12px; font-weight:100; line-height:20px;" href="' . tep_href_link('quote.php', 'oID=' . $_GET['oID']. '') . '" TARGET="_blank"><i class="fa fa-envelope-o" style="margin-right:5px;"></i>Send Quote</a></button>'; ?></div>
             <div class="main col-xs-5" style="float:none;  margin-bottom:10px;"><?php echo '<button id="send-tracking"  class="btns" style="width:140px; display:inline-block; height:25px;" type="button" onClick="sendTracking(112)"><a style="display:block; width:100%; color:#FFF; font-size:12px; font-weight:100; line-height:20px;" href="' . tep_href_link('tracking.php', 'oID=' . $_GET['oID']. '') . '" TARGET="_blank"><i class="fa fa-envelope-o" style="margin-right:5px;"></i>Send Tracking Info</a></button>'; ?></div>
             <div class="main col-xs-5" style="float:none;"><?php echo '<button class="btns" style="width:140px; display:inline-block; height:25px;" type="button"><a style="display:block; width:100%; color:#FFF; font-size:12px; font-weight:100; line-height:20px;" href="' . tep_href_link('gift_certificate.php', 'oID=' . $_GET['oID']. '&action=email') . '" TARGET="_blank"><i class="fa fa-envelope-o" style="margin-right:5px;"></i>Gift Certificate</a></button>'; ?></div>
	...
	<script language="JavaScript" type="text/javascript">
     <!--
		 ...
		 document.write("<input type=\"button\" name=\"comments_button\" class=\"btns form-group\" style=\"background:#ccc; color:#000 !important; display:inline-block; height:25px;\" value=\"<?php echo 'Submit New Comments/Status' ?>\" onClick=\"getNewComment();\">");
		 document.write("</td>");
		 document.write("</tr>");
	 //-->
    </script>
	<?php } ?>  <button class="btns form-group" style="width:140px; display:inline-block; height:25px; margin-left:20px; background:#ccc !important; color:#000 !important;" type="button" onClick="updateStatusField(3)">Delivered</button></div>				  
</div></div>
    ...
    <?php
      $orders_history_query = tep_db_query("SELECT orders_status_history_id, orders_status_id, date_added, customer_notified, comments 
        ...
        if (tep_db_num_rows($orders_history_query)) {
         ...
         '	  <td class="" align="center"><div id="do_not_delete"><input name="update_comments[' . $orders_history['orders_status_history_id'] . '][delete]" type="checkbox" onClick="updateCommentsField(\'delete\', \'' . $orders_history['orders_status_history_id'] . '\', this.checked, \'\', this)"></div></td>' . "\n" . 
		
         '    <td class="" align="center">' . tep_datetime_short($orders_history['date_added']) . '</td>' . "\n" .
    
         '    <td class="" align="center">';
		 } else {
		 echo '  <tr class="' . $rowClass . '" id="commentRow' . $orders_history['orders_status_history_id'] . '" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this, \'' . $rowClass . '\')">' . "\n" .
         '	  <td class="" align="center"><div id="do_not_delete"><input name="update_comments[' . $orders_history['orders_status_history_id'] . '][delete]" type="checkbox"></div></td>' . "\n" . 
         '    <td class="" align="center">' . tep_datetime_short($orders_history['date_added']) . '</td>' . "\n" .
         '    <td class="" align="center">';
		 }
    ...
    elseif ($orders_history['customer_notified'] == '3') {
	 ...
	 elseif ($orders_history['customer_notified'] == '1') {
      ...
      echo tep_image(DIR_WS_ICONS . 'cross.gif', ICON_CROSS) . "</td>\n";
	    ...
	    echo '    <td class="" align="left">' . $orders_status_array[$orders_history['orders_status_id']] . '</td>' . "\n";
