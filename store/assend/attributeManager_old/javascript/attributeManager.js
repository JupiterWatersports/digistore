...
//	var sortOrder = getDropDownValue('newSort');
	...
	if(0 == option || 0 == optionValue)
		return false;
	amSendRequest('amAction=addAttributeToProduct&option_id='+option+'&option_value_id='+optionValue+'&prefix='+pricePrefix+'&price='+price+'&quantity_id='+quantity_id+'&sortOrder='+sortOrder+/*'&weight_prefix='+weightPrefix+*/'&weight='+weight);
	return false;
}
