...
?>	
					...
					Qty ID: <?php echo tep_draw_input_field("price_$optionValueId",$optionValueInfo['quantity_id'],' style="margin:3px 0px 3px 0px;" id="quantity_id_'.$optionValueId.'" size="7" onfocus="amF(this)" onblur="amB(this)" onChange="return amUpdate(\''.$optionId.'\',\''.$optionValueId.'\',\'quantity_id\');"'); ?>
<?php 
...
<!-- ----- -->
	...
	<table border="0"  cellpadding="0" cellspacing="0">
		<tr>
			...
			<td valign="top" class="newOptionPanel-label">
				Qty ID: <?php echo tep_draw_input_field('newQuantity_id','','size="4" id="newQuantity_id"'); ?>
			</td>
<?php 
// More Product Weight added by RusNN
  if (AM_USE_MPW) {
