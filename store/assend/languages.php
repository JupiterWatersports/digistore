...
// create additional Extra Product Field Product Type records
        $epf_query = tep_db_query("select ptype_id, ptype_description from " . TABLE_PTYPE_DESC . " where languages_id = " . (int)$languages_id);
        while ($epf = tep_db_fetch_array($epf_query)) {
          tep_db_query("insert into " . TABLE_PTYPE_DESC . " (ptype_id, languages_id, ptype_description) values ('" . (int)$epf['ptype_id'] . "', '" . (int)$insert_id . "', '" . tep_db_input($epf['ptype_description']) . "')");
        }
...
// create additional orders_status records
      ...
      case 'deleteconfirm':
        ...
        tep_db_query("delete from " . TABLE_PTYPE_DESC . " where languages_id = '" . (int)$lID . "'");
