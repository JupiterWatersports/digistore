	...
	foreach(${AM_SESSION_VAR_NAME} as $newAttribute) {
		...
		$newAttributeData = array(
			...
			'options_id' => amDB::input($newAttribute['option_id']),
        		...
        		'options_quantity_id' => amDB::input($newAttribute['quantity_id']),
        		'options_model_no' => amDB::input($newAttribute['model_no']),
        		'options_serial_no' => amDB::input($newAttribute['serial_no']),
        		'options_quantity' => amDB::input($newAttribute['quantity']),
