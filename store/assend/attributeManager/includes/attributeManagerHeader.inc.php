...
if('new_product' == $action || 'update_product' == $action || 'edit_product' == $action) {
...
function goOnLoad() {
	<?php	if('new_product' == $action || 'update_product' == $action || 'edit_product' == $action) echo 'attributeManagerInit();';	?>
