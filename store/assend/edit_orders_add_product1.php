...
tep_session_register(oID);
 $oID =$_GET['oID']; ?>
            <td>&nbsp;</td>
            <td class="dataTableContent" valign="top"><div id="form" >&nbsp;<input type="text" id="searchbox" name="product_search" value="<?php if(isset($_POST['product_search'])) echo $_POST['product_search']; ?>" onchange="this.form.submit();"></div><div id="resultsContainer"></div>
			</td>
...
<?php
  ...
  if ($step > 3) {
    echo '          <tr class="dataTableRow">' . "\n" .
         ...
         '            <td colspan="3" style="border-top: 1px solid #C9C9C9;">' . tep_draw_separator('pixel_trans.gif', '1', '1') . '</td>' . "\n" .
         '          </tr>' . "\n" .
         '          <tr class="dataTableRow">' . "\n" .tep_draw_form('configuration', FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $_GET['oID'] .  '&action=add_product') .
