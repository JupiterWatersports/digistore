...
<a href="' . tep_href_link(FILENAME_ORDERS_LABEL, 'oID=' . $oInfo->orders_id) . '" TARGET="_blank">' . tep_image_button('button_label.gif', IMAGE_ORDERS_LABEL) . '</a>' .
