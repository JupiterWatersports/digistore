  ...
  if (($step > 2) && ($add_product_products_id > 0)) {
    ...
    if ($has_attributes) {
      ...
      while ($products_options_name = tep_db_fetch_array($products_options_name_query)) {
        ...
        $products_options_query = tep_db_query("select pov.products_options_values_id, pov.products_options_values_name, pa.options_values_price, pa.price_prefix, pa.options_quantity, pa.options_serial_no from " . TABLE_PRODUCTS_ATTRIBUTES . " pa, " . TABLE_PRODUCTS_OPTIONS_VALUES . " pov where pa.products_id = '" . (int)$add_product_products_id . "' and pa.options_id = '" . $products_options_name['products_options_id'] . "' and pa.options_values_id = pov.products_options_values_id and pov.language_id = '" . $languages_id . "'");
