  ...
  class manualOrder {
    ...
    function query($order_id) {
      ...
      // new line for cc_number setting
              ...
              'payment_nonce' => $order['payment_nonce'],
                          'tax' => 0,
                          'tax_groups' => array());
      ...
      $index = 0;
      $orders_products_query = tep_db_query("select orders_products_id, products_id, products_name, products_model, products_msrp, products_price, products_tax, products_quantity, final_price from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . (int)$order_id . "' order by orders_products_id");
      ...
      while ($orders_products = tep_db_fetch_array($orders_products_query)) {
        ...
        $subindex = 0;
        $attributes_query = tep_db_query("select products_options, products_options_values, options_values_price, price_prefix, orders_products_attributes_id, serial_no from " . TABLE_ORDERS_PRODUCTS_ATTRIBUTES . " where orders_id = '" . (int)$order_id . "' and orders_products_id = '" . (int)$orders_products['orders_products_id'] . "'");
