          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                ...
                <? // BOF: Who's Shopping Enhancement ?>
               <td class="dataTableHeadingContent"><?php echo TABLE_HEADING_SHOPPING; ?>&nbsp;</td> 
               <? // EOF: Who's Shopping Enhancement ?>
              </tr>
<?php
  $whos_online_query = tep_db_query("select shopping, customer_id, full_name, ip_address, time_entry, time_last_click, last_page_url, session_id from " . TABLE_WHOS_ONLINE);
...
?>
                ...
                <? // BOF: Who's Shopping Enhancement ?>
		   <td class="dataTableContent" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $whos_online['shopping']; ?></td> <? //jfr ?>
               <? // EOF: Who's Shopping Enhancement ?>  
              </tr>
<?php
  }
