...
// define general functions used application-wide
  ...
  // Products Specofocations
  require(DIR_WS_FUNCTIONS . 'clean_code.php');
...
// End get 1 free
      ...
      ///// SID-KILLER ( change ) /////////// all $_GET in "case 'buy_now'" exchanged to $_POST cuz BTN-mode was changed to a form instead of a link.
...
<link rel="stylesheet" media="screen and (-webkit-min-device-pixel-ratio:0) and (min-resolution: .001dpcm)" href="css/chrome-reset.css"  type="text/css" />
<script src="ext/jquery/jquery.min.js" type="text/javascript"></script>';
...
if ( ! tep_session_is_registered('idorder') ) {
tep_session_register('idorder');
}
if ( ! tep_session_is_registered('cname') ) {
tep_session_register('cname');
}
?>
