...
?>
  ...
  <tr>
    <td class="main" style="width:40%;"><?php echo ENTRY_FIRST_NAME; ?>&nbsp;</td>
  	<td class="main" style="width:60%;"><?php echo tep_draw_input_field('billing_firstname', (isset($billingAddress) ? $billingAddress['firstname'] : ''), 'class="required" style="width:80%;float:left;"'); ?></td>
  </tr>
  <tr>
  	<td class="main" style="width:40%;"><?php echo ENTRY_LAST_NAME; ?>&nbsp;</td>
  	<td class="main" style="width:60%;"><?php echo tep_draw_input_field('billing_lastname', (isset($billingAddress) ? $billingAddress['lastname'] : ''), 'class="required" style="width:80%;float:left;"'); ?></td>
  </tr>
...
?>
 <tr>
  <td class="main" nowrap><?php echo ENTRY_DATE_OF_BIRTH . ' (dd/mm/yyyy)'; ?></td>
  <td class="main" style="width:60%;"><?php echo tep_draw_input_field('billing_dob', (isset($customerAddress) ? $customerAddress['dob'] : ''), 'class="required" style="width:80%;float:left;"'); ?></td>
 </tr>
<?php
  }
...
?>
 <tr id="newAccountEmail">
  ...
  <td class="main" style="width:60%;"><?php echo tep_draw_input_field('billing_email_address', (isset($customerAddress) ? $customerAddress['email_address'] : ''), 'class="required" style="width:80%;float:left;"'); ?></td>
 </tr>
<?php
  }
...
?>
 <tr>
  ...
  <td class="main" style="width:60%;"><?php echo tep_draw_input_field('billing_company', (isset($billingAddress) ? $billingAddress['company'] : ''), 'style="width:80%;float:left;"'); ?></td>
 </tr>
<?php
  }
?>
...
?>
 <tr>
  ...
  <td class="main" style="width:60%;"><?php echo tep_draw_input_field('billing_suburb', (isset($billingAddress) ? $billingAddress['suburb'] : ''), 'style="width:80%;float:left"'); ?></td>
 </tr>
<?php
  }
?>
 <tr>
  <td colspan="2">
    <table cellpadding="0" cellspacing="0" border="0" width="89%">
      <tr>
	      <td class="main" style="width:5%;" nowrap><?php echo ENTRY_CITY; ?>&nbsp;</td>
        <td class="main" style="width:20%;"><?php echo tep_draw_input_field('billing_city', (isset($billingAddress) ? $billingAddress['city'] : ''), 'class="required" style="width:80%;float:left;"'); ?></td>
<?php
  if (ACCOUNT_STATE == 'true') {
?>
	      <td class="main" style="width:10%;"><?php echo ENTRY_STATE; ?></td>
<?php
...
?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="89%">
      <tr style="padding-top:5px;">
      	<td class="main" style="width:10%;" nowrap><?php echo ENTRY_POST_CODE; ?></td>
      	<td class="main" style="width:20% text-align:left;"><?php echo tep_draw_input_field('billing_zipcode', (isset($billingAddress) ? $billingAddress['postcode'] : ''), 'class="required" style="width:20%;float:left;"'); ?></td>
<?php 
}
?>
      </tr>
