...
define('BOX_REVIEWS_TEXT_OF_5_STARS', '%s out of 5');
...
define('TEXT_REVIEW_DATE_ADDED', 'on %s');
...
/* This is added for Price Filter */



define('TEXT_SHOW_PRICE', '<b>Price:</b>');
...
$price_ranges_sql = Array(  "p.products_price < 10" ,
							"(p.products_price <= 20 AND p.products_price >= 10)",
							"(p.products_price <= 30 AND p.products_price >=  20 )",
							"(p.products_price <= 50 AND p.products_price >=  30 )",
							"p.products_price > 50",
							"p.products_price > 0");

/* Added for Price Filter closed */
