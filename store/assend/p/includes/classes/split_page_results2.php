...
// previous button - not disabled on first page
       if ($this->current_page_number > 1) $display_links_string .= '<li ><span class="prevnext disabled"><a href="' . tep_href_link(basename($PHP_SELF), $parameters . $this->page_name . '=' .  ($this->current_page_number - 1), $request_type) . '"  title=" ' . PREVNEXT_TITLE_PREV_PAGE . ' " class="nextprev">' . PREVNEXT_BUTTON_PREV . '</a></span></li>';
	   	else {
        $display_links_string .= '<li class="disabled" ><span class="nextprev disabled">' . PREVNEXT_BUTTON_PREV. '</span></li>';
      }
...
// next button
      ...
      if (($this->current_page_number < $this->number_of_pages) && ($this->number_of_pages != 1)) $display_links_string .= '<li ><span class="prevnext"><a href="' . tep_href_link(basename($PHP_SELF), $parameters . 'page=' . ($this->current_page_number + 1), $request_type) . '"  title=" ' . PREVNEXT_TITLE_NEXT_PAGE . ' ">' . PREVNEXT_BUTTON_NEXT . '</a></span></li>';
      	else {
        $display_links_string .= '<li class="disabled" ><span class="prevnext disabled">' . PREVNEXT_BUTTON_NEXT. '</span></li>';
      }
