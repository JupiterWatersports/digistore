...
// previous button - not disabled on first page
       if ($this->current_page_number > 1) $display_links_string .= '<li><a href="' . tep_href_link(basename($PHP_SELF), $parameters . $this->page_name . '=' .  ($this->current_page_number - 1), $request_type) . '"  title=" ' . PREVNEXT_TITLE_PREV_PAGE . ' " class="nextprev">' . PREVNEXT_BUTTON_PREV . '</a></li>';
	   	else {
...
// next window of pages
      if ($cur_window_num < $max_window_num) $display_links_string .= '<li><span href="' . tep_href_link(basename($PHP_SELF), $parameters . $this->page_name . '=' . (($cur_window_num) * $max_page_links + 1), $request_type) . '"  title=" ' . sprintf(PREVNEXT_TITLE_NEXT_SET_OF_NO_PAGE, $max_page_links) . ' ">...</span></li>';
