...
// change name to infobox header
	...
	function tep_infobox_header($content,$imagedir){
		...
		$tep_output = "<table width='100%' border='0' class='infoBoxHeading'>
...
// select and show homepage advertisements, default set to random
		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0' align='right' class='instoreAdvertisement'>

    	<tr>

    		<td width='100%' height='131' valign'top' background='$imagedir$image'  style='background-repeat:no-repeat;background-position:right '><table width='100%'  border='0' cellspacing='0' cellpadding='0'>
