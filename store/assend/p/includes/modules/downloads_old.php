...
// Get last order id for checkout_success
    $orders_query = tep_db_query("select orders_id " . TABLE_ORDERS . " where customers_id = '" . (int)$customer_id . "' order by orders_id desc limit 1");
...
// Now get all downloadable products in that order
  ...
  $Order_status = tep_db_fetch_array($downloads_query);
  $status = $Order_status['$Order_status'];
  $flag = $Order_status['downloads_flag'];
