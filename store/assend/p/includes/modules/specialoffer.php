...
if (($product_info1['products_id'] == '4197') ||  ($product_info1['products_id'] == '5240') || ($product_info1['products_id'] == '3899')) {  ?>
...
<div class="offer-image"><a target="_blank" href="2013-cabrinha-custom-board-only-p-5261.html"><img style="width:150px;" src="images/2013_cabrinha_custom(sm).jpg"></a></div>
...
<?php
  echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_PRODUCT_INFO, tep_get_all_get_params(array('action')) . 'action=add_product'));
  if (((STOCK_CHECK == "true")&&($product_info1['products_quantity'] > 0)) or (STOCK_ALLOW_CHECKOUT == "true")) {
    echo '<button class="cssButton addtocart" style="border:none;">'.tep_draw_hidden_field('products_id', '5261'). 'Add To Cart'.'</button>';
  } else {
    echo tep_draw_separator('pixel_trans.gif', '1', '22');
  }
?></form>
