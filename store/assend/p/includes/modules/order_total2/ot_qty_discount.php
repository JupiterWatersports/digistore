...
*/
  ...
  class ot_qty_discount {
    ...
    function calculate_discount($amount) {
      ...
      $od_amount = 0;
      if ((MODULE_QTY_DISCOUNT_DISABLE_WITH_COUPON == 'true') && (isset($_SESSION['coupon_code_code']))) return $od_amount;
