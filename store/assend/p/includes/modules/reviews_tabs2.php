...
<p class="right-align">Customer Reviews <?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS, 'products_id=' . $product_info['products_id'] . '&reviews_id=' . $reviews['reviews_id']) . '">' ; ?> (view all <?php echo '<span>'.$reviews['count']. $reviews_no.'</span>'; ?> reviews)</a></p>		    
<div class="clear"></div>        
