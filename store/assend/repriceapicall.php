...
echo '<h3>RePrice API CALL    </h3>';
// RePrice API CALL    
$url='https://api.signifyd.com/v3/orders/events/repricings';
...
// $resparray_check=json_decode($response, true);
 ...
 //$signifydId=$resparray_check['signifydId'];
             ...
             curl_setopt($ch, CURLOPT_POSTFIELDS,  $casesampledatat2);
