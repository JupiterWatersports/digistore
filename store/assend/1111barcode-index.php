...
?>
	<div class="label-wrapper">
		...
		<img class="header-img logo-show" src="images/jup-kitepaddlewake.png" border="0" width="160px" style="margin-bottom:-5px;" />
...
if ((isset($option_value_price)) && (!is_null(option_value_price))) {
     if ($prefix=='-') {
...
if ($special_products_price_msrp == $special_products_price) {
			...
			echo '<span style="text-decoration:line-through;">$'.$special_products_price_msrp . '</span><span class="special-price" style="margin-left:10px;">$'.$special_products_price. '</span>';}
...
.callout {z-index:20;position:absolute;top:30px;border:0;left:-12px;}
					...
					<form id="form_generator" action="" method="post">
                        ...
                        <div class="select-all" style="margin:60px auto 15px auto; text-align:center;">
                   <label style="margin-right:-60px; font-size:18px">Step 3:</label>
                   <a id="regsize" class="extra-btn">2.4" Label</a>
                   <a style="margin-left:10px;" id="sunglasssize" class="extra-btn" >1.4" Sunglass Label</a>
                   <a style="margin-left:10px;" id="smallsize" class="extra-btn" >1.1" Label</a>
	...
	$menulink2.click(function(e) {
     ...
     $("body").css({'font-size' :""});
	  $("body").css({'margin':"0px 0 0 0"});
	 $(".label-wrapper").css({'border':""});
	 $(".label-wrapper").css({'margin':""});
	 $(".result_container").css({'margin': ""});
	 ...
	 $(".label-wrapper").css({'border':"none"});
	  $(".label-wrapper").css({'margin':"10px 0px 0px"});
	 $(".result_container").css({'margin': "1px 0 0 0"});
...
.logo-btn-show{display:inline-block; margin-left:10px;}</style>
                  ...
                  <div style="display:inline;"><label style="font-size:18px; height:170px; width: 80px;">Step 4:</label>
