...
?>
          <tr>
            ...
            <td class="main"><?php echo '&nbsp;' . tep_draw_input_field('pages_title[' . $languages[$i]['id'] . ']', (isset($pages_title[$languages[$i]['id']]) ? $pages_title[$languages[$i]['id']] : tep_get_pages_title($pInfo->pages_id, $languages[$i]['id']))); ?></td>
          </tr>
<?php
    }
?>
...
?>
          <tr>
            ...
            <td><table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="main"><?php echo tep_draw_fckeditor('pages_body[' . $languages[$i]['id'] . ']', '600', '500',  (isset($pages_body[$languages[$i]['id']]) ? $pages_body[$languages[$i]['id']] : tep_get_pages_body($pInfo->pages_id, $languages[$i]['id']))); ?></td>
              </tr>
            </table></td>
          </tr>
<?php
