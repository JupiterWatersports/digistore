...
echo '<div><a style="width:100%;align:left;">'. tep_draw_form('search', 'stats_sales_report2.php', '', 'get').'<input type="hidden" name="cID" value="'.$customers_id.'"><input type="text" name="customer_name"  value="' . $url_title . '" readonly style="width:400px; background:#fff; border:none; align:left;" onclick="this.form.submit();"></form></div>
';
}
