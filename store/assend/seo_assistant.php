...
*/
  ...
  $action_harmful = (isset($_POST['harmfulURL']) ? $_POST['harmfulURL'] : '');

  $action_hotlink = (isset($_POST['hotlinkURL']) ? $_POST['hotlinkURL'] : '');
  ...
  /********* CHECK HARMFUL LINKS *********/    
	...
	elseif (tep_not_null($action_harmful))	{ 

    $harmfultotal = tep_db_prepare_input($_POST['searchcount_harmful']);

   

    if (! empty($harmfultotal))

    {

	    $searchurl = tep_db_prepare_input($_POST['harmfulURL']);

      $searchurl = GetSearchURL($searchurl);

        

      $foundHarmful_Google = 0;

      $hits_per_page = 10;  

      $harmfulURL_Google = array();

      $totalHarmfulLinks_Google = 0;

      include(DIR_WS_MODULES . 'seo_check_harm_warning.php');
  ...
  /********* HOTLINKS CHECK *********/    
	...
	elseif (tep_not_null($action_hotlink))	{ 

 

    $hotlinktotal = tep_db_prepare_input($_POST['searchcount_hotlink']);

   

    if (! empty($hotlinktotal))

    {

	    $searchurl = tep_db_prepare_input($_POST['hotlinkURL']);

      $searchurl = GetSearchURL($searchurl);

        

      $foundHotlink_Google = 0;

      $hits_per_page = 20;  

      $hotlinkURL_Google = array();

      $totalHotlinkLinks_Google = 0;

      include(DIR_WS_MODULES . 'seo_check_hotlinking.php');

      $showhotlinks = ($_POST['show_hotlinks'] == 'on') ? 1 : 0;
            ...
            <tr>
             ...
             <td>
              ...
              <ul id="seo_ul">
               ...
               <li><a title="Index Position" href="<?php echo PageLink('index'); ?>"><?php echo TEXT_ANCHOR_INDEX; ?></a></li>

               <li><a title="Page Rank" href="<?php echo PageLink('pagerank'); ?>"><?php echo TEXT_ANCHOR_PAGERANK; ?></a></li>

               <li><a title="Page Rank" href="<?php echo PageLink('harmful'); ?>"><?php echo TEXT_ANCHOR_HARMFUL; ?></a></li>               
             ...
             <td>
              ...
              <ul id="seo_ul">
               ...
               <li><a title="Link Popularity" href="<?php echo PageLink('linkpop'); ?>"><?php echo TEXT_ANCHOR_LINKPOP; ?></a></li>

               <li><a title="Keyword Density" href="<?php echo PageLink('density'); ?>"><?php echo TEXT_ANCHOR_KEYDENSITY; ?></a></li>

               <li><a title="Hot Linking Check" href="<?php echo PageLink('hotlink'); ?>"><?php echo TEXT_ANCHOR_HOTLINK; ?></a></li>
             ...
             <td>
              ...
              <ul id="seo_ul">
               ...
               <li><a title="Check Links" href="<?php echo PageLink('checklinks'); ?>"><?php echo TEXT_ANCHOR_CHECK_LINKS; ?></a></li>

               <li><a title="Header Status" href="<?php echo PageLink('headerstatus'); ?>"><?php echo TEXT_ANCHOR_HEADER_STATUS; ?></a></li>
             ...
             <td>
              ...
              <ul id="seo_ul">
               ...
               <li><a title="Check Sids" href="<?php echo PageLink('checksids'); ?>"><?php echo TEXT_ANCHOR_SIDS; ?></a></li>

               <li><a title="Supplemental" href="<?php echo PageLink('supplemental'); ?>"><?php echo TEXT_ANCHOR_SUPPLEMENTAL; ?></a></li>
            ...
            <td class="seo_section"><b><?php echo TEXT_MSN; ?></b></td>
             ...
             <td class="smallText" colspan="3"><?php print($result_msn);?></td>
				     ...
				     <td>&nbsp;</td>
						...
						<?php if ($found_msn && $show_history && tep_db_num_rows($msn_prev_query)) {	?>							 
         ...
         <tr>
          ...
          <td><table border="0" cellspacing="2" cellpadding="2">
           ...
           <tr> 
            ...
            <td width="50%" class="smallText"> <script>document.writeln('<a style="cursor:pointer" onclick="javascript:popup=window.open('
            ...
            <?php if ($showsupplementalLinks && count($supplementalURL_Google)) {  
             ...
             for ($i = 0; $i < count($supplementalURL_Google); ++$i) { ?>
              ...
              <tr>
               ...
               <td class="smallText"><a href="<?php echo $supplementalURL_Google[$i]; ?>" target="_blank"><?php echo $supplementalURL_Google[$i]; ?></a></td>
       ...
       <!-- BEGIN CHECK HARMFUL CODE --> 			
         ...
         <td><?php echo tep_black_line(); ?></td>
          ...
          <tr>
           ...
           <td class="seo_subHead"><?php echo HEADING_TITLE_HARMFUL; ?></td>

          </tr>			

           <tr>

            <td class="seo_section"><?php echo TEXT_HARMFUL; ?></td>
         ...
         <td><table border="0" cellspacing="2" cellpadding="2">
           ...
           <td><?php  echo tep_draw_input_field('searchcount_harmful', tep_not_null($searchtotal) ? $searchtotal : '100', 'maxlength="255"', false); ?> </td>
          ...
          <tr> 
           ...
           <td><?php echo tep_draw_input_field('harmfulURL', tep_not_null($searchurl) ? $searchurl : '', 'maxlength="255", size="40"',   false); ?> </td>

    	     <td ><?php echo (tep_image_submit('button_harmful.gif', IMAGE_CHECK_HARMFUL) ); ?></td>
         ...
         <tr class="infoBoxContents">
          ...
          <td><table border="0" cellspacing="2" cellpadding="2">
           ...
           <tr>
            ...
            <td><?php echo tep_draw_checkbox_field('show_harmful_links', $harmfullinks, false, ''); ?> </td>
         ...
         <?php if (tep_not_null($action_harmful)) { ?>
          ...
          <tr class="infoBoxContents">
           ...
           <td><table border="0" cellspacing="2" cellpadding="2">
            ...
            <tr> 
	 			    ...
	 			    <td class="seo_section"><?php echo sprintf("%s: %s",TEXT_TOTAL_LINKS_LISTED, $totalHarmfulLinks_Google); ?> </td>

				   </tr>		

            <tr>

             <td class="seo_section"><?php echo sprintf("%s: %d",TEXT_TOTAL_HARMFUL_FOUND, $foundHarmful_Google); ?> </td>

            </tr> 

            <?php if ($harmfulLinks && count($harmfulURL_Google)) {  

             for ($i = 0; $i < count($harmfulURL_Google); ++$i) { ?>

              <tr>

               <td class="smallText"><a href="<?php echo $harmfulURL_Google[$i]; ?>" target="_blank"><?php echo $harmfulURL_Google[$i]; ?></a></td>
         ...
         <tr>
          ...
          <td class="seo_section" align="right"><a title="Top" href="<?php echo PageLink('top'); ?>"> Top</a></td>
			...
			<!-- END CHECK HARMFUL CODE --> 

      

        <!-- BEGIN HOTLINKING CHECK CODE --> 			
         ...
         <td><?php echo tep_black_line(); ?></td>
          ...
          <tr>
           ...
           <td class="seo_subHead"><?php echo HEADING_TITLE_HOTLINK; ?></td>

          </tr>			

          <tr>

           <td class="seo_section"><?php echo TEXT_HOTLINK; ?></td>
         ...
         <td><table border="0" cellspacing="2" cellpadding="2">
           ...
           <td><?php  echo tep_draw_input_field('searchcount_hotlink', tep_not_null($searchtotal) ? $searchtotal : '100', 'maxlength="255"', false); ?> </td>
          ...
          <tr> 
           ...
           <td><?php echo tep_draw_input_field('hotlinkURL', tep_not_null($searchurl) ? $searchurl : '', 'maxlength="255", size="40"',   false); ?> </td>

    	     <td ><?php echo (tep_image_submit('button_hotlinking.gif', IMAGE_CHECK_HOTLINK) ); ?></td>
         ...
         <tr class="infoBoxContents">
          ...
          <td><table border="0" cellspacing="2" cellpadding="2">
           ...
           <tr>
            ...
            <td><?php echo tep_draw_checkbox_field('show_hotlinks', $showsupplementallinks, false, ''); ?> </td>
         ...
         <?php if (tep_not_null($action_hotlink)) { ?>
          ...
          <tr class="infoBoxContents">
           ...
           <td><table border="0" cellspacing="2" cellpadding="2">
            ...
            <tr> 
	 			    ...
	 			    <td class="seo_section"><?php echo sprintf("%s: %s",TEXT_TOTAL_LINKS_LISTED, $totalHotlinkLinks_Google); ?> </td>

				   </tr>		

            <tr>

             <td class="seo_section"><?php echo sprintf("%s: %d",TEXT_TOTAL_HOTLINKS_FOUND, $foundHotlink_Google); ?> </td>

            </tr> 

            <?php if ($showhotlinks && count($hotlinkURL_Google)) {  

             for ($i = 0; $i < count($hotlinkURL_Google); ++$i) { ?>

              <tr>

               <td class="smallText"><a href="<?php echo $hotlinkURL_Google[$i]; ?>" target="_blank"><?php echo $hotlinkURL_Google[$i]; ?></a></td>
