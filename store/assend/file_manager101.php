...
/*
  ...
  $Id: file_manager.php,v 1.42 2005/11/01 22:50:52 hpdl Exp $   

   ============================================  

   DIGISTORE FREE ECOMMERCE OPEN SOURCE VER 4.0 
   ...
   Portions Copyright (c) 2007 osCommerce
...
<table border="0" width="100%" cellspacing="2" cellpadding="2" height="300">
  ...
  <tr>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr><?php echo tep_draw_form('goto', FILENAME_FILE_MANAGER, '', 'get'); ?> 
                ...
                <td class="pageHeading"><?php echo '<span class="smallText">' . $current_path . '</span>&nbsp;';?></td>

                <td class="pageHeading" align="right">&nbsp;</td>

                <td class="pageHeading" align="right"><?php echo tep_draw_pull_down_menu('goto', $goto_array, $current_path, 'onChange="this.form.submit();"'); ?></td></form>
