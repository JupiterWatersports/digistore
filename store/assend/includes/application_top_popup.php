...
// Since this is a temporary measure this message is hardcoded. The require_oncement will be removed before 2.2 is finalized.
  /*if (function_exists('ini_get')) { // Register Globals MOD - http://www.magic-seo-url.com
    ini_get('register_globals') or exit('Server require_oncement Error: register_globals is disabled in your PHP configuration. This can be enabled in your php.ini configuration file or in the .htaccess file in your catalog directory.');
  }*/
...
// include the text encrypt/decrypt functions
  require_once(DIR_WS_FUNCTIONS . 'en_de_crypt.php');
