...
*/
$ignore_before = date('Y-m-d h:m:s', strtotime("-15 days"));
/*
...
$limit_xsell_products = '3';
 switch ($action){
	case 'send';
 		...
 		$count_query = tep_db_query("select count(*) as count, c.customers_lastname
...
//get the target group. mmstatus must be set to '0'
		$mail_query = tep_db_query("select c.customers_firstname, c.customers_lastname, c.mmstatus, o.orders_id,
					...
					from " . TABLE_ORDERS . " o, " . TABLE_CUSTOMERS . " c, orders_products op
					where o.customers_id = c.customers_id and c.customers_id ='2928'
					and op.orders_id = o.orders_id
					and  op.products_id='4077'
...
// get the products 		
	...
	<td style="width:100%; text-align:center;"><img style="width:100%; max-width:250px; text-align:center;"" src="images/jup-kitepaddlewake.png" alt="Jupiter"></td></tr>
	<tr><td><hr style="margin-bottom:20px;"></td></tr>
	<tr><td>'.$mail['customers_firstname'].',</td></tr><tr><td>&nbsp;</td></tr>
	<tr><td>Thank you for your recent purchase from us, we hope you were pleased with both our service and what you ordered. Hopefully at this time you have had a chance to use your product and we would appreciate it if you could please write a Product Review for us. We know how scarce time can be so we especially appreciate your time and input.</td></td>
	<tr><td>&nbsp;</td></tr>
	<tr><td>Thanks,</td></tr>
