...
// ab hier wird die datei geschrieben 
  ...
  function si_writehtml($si_id, $i)  {
    ...
    // Dies ist ein workaround: je nach Konfiguration sollte einer der beiden folgenden funktionsaufrufe funktionieren, der andere richtet zumindest keinen Schaden an... 
      if (is_dir(DIR_WS_CATALOG_LANGUAGES . $languages[$i-1]['directory'])) { 
        ...
        si_html_output($si_url, $queryarray['si_heading'], $queryarray['si_content'], tep_date_short($queryarray['si_stamp']));
      }
     //eof workaround
    } // if
  } // EOF si_writehtml() 
  ...
  global $si_id, $i, $si_heading, $si_content, $si_url, $si_sort, $si_iframe, $si_name, $si_type;
    ...
    if (($alreadyset['si_name'])) {
      tep_db_query("UPDATE information set si_id='" . $si_id . "', si_name='" . $si_name . "', language_id='" . $i . "', si_sort='" . $si_sort . "', si_type='" . $si_type . "' , si_heading='" . $si_heading . "' , si_content='" . $si_content . "', si_url='" . $si_url . "', si_iframe='" . $si_iframe . "'  WHERE si_id='" . $si_id . "' and language_id='"  . $i . "'");
    } else {
      tep_db_query("INSERT INTO information (si_id, si_name, language_id, si_sort, si_type, si_heading, si_content, si_url, si_stamp, si_iframe) VALUES ('" . $si_id . "', '" . $si_name . "', '" . $i . "', '" . $si_sort . "' , '" . $si_type . "', '" . $si_heading . "', '" . $si_content . "', '" . $si_url . "', '" . $si_iframe . "')");
      $var = mysql_insert_id();
      if ($var != $si_id) {
...
global $si_id, $si_key, $si_heading, $si_content, $si_url, $si_sort, $si_iframe, $si_name, $si_type;
  if ($i == 1) {
    tep_db_query("INSERT INTO information (si_name, language_id, si_sort, si_type, si_heading, si_content, si_url, si_iframe) VALUES ('" . $si_name . "', '" . $i . "', '" . $si_sort . "' , '" . $si_type . "', '" . $si_heading . "', '" . $si_content . "', '" . $si_url . "' , '" . $si_iframe . "')");
    $si_id = mysql_insert_id();
    return $si_id;
    } else {
      tep_db_query("INSERT INTO information (si_id, si_name, language_id, si_sort, si_type, si_heading, si_content, si_url, si_iframe) VALUES ('" . $si_id . "', '" . $si_name . "', '" . $i . "', '" . $si_sort . "' , '" . $si_type . "', '" . $si_heading . "', '" . $si_content . "', '" . $si_url . "', '" . $si_iframe . "')");
      $var = mysql_insert_id();
      if ($var != $si_id) {
        tep_db_query("UPDATE information set si_id='" . $si_id . "' WHERE si_id='" . $var . "'");
      } // if $var
