...
?>
<body bgcolor="<?php echo BACKGROUND_COLOUR; ?>">
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr class="header">
    <td height="65" valign="middle"><?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . tep_image(DIR_WS_IMAGES . 'logo.jpg', STORE_NAME) . '</a>'; ?></td>
<?php
...
<td align="right" bgcolor='<?php echo TITLE_BAR_BG; ?>' valign="middle" height="15">
         ...
         <td valign="middle" style="padding:4px 10px 0px 10px"><?php require(DIR_WS_BOXES . 'header_languages.php'); ?> </td></tr></table></td>
  </tr>
</table>
<table border="0" width="100%" cellspacing="0" cellpadding="0">
...
<td  align="right" style="padding:0px 11px 0px 10px" class="headerCrumb" valign="middle">
					...
					<?php echo tep_draw_form('quick_find', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get') . tep_draw_hidden_field('search_in_description','1') . tep_draw_input_field('keywords', '', 'size="10" maxlength="30" style="width: 140px"') . '<td valign="middle" style="padding:0px 0px 0px 10px">' . tep_hide_session_id() . tep_image_submit('button_quick_find.gif', BOX_HEADING_SEARCH). '</a></form></td></tr></table></td>'; ?></td>
  </tr>
</table>
