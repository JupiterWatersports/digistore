...
*/ 
  ...
  define('HEADING_TITLE', '<a name="top" class="seoHead">SEO Assistant V 2.1</a>');
  ...
  define('HEADING_TITLE', 'Search Engine Ranking');
	define('HEADING_TITLE_HOTLINK', '<a name="hotlink"></a>HotLinking Check');   
  ...
  define('HEADING_TITLE_HARMFUL', '<a name="harmful"></a>Harmful Links');  
  
  define('TEXT_ANCHOR_INDEX', 'Index Position');
  define('TEXT_ANCHOR_PAGERANK', 'Page Rank');
  define('TEXT_ANCHOR_HARMFUL', 'Harmful Links');   
  define('TEXT_ANCHOR_HOTLINK', 'Hot Linking');            
  define('TEXT_ANCHOR_LINKPOP', 'Link Popularity');
  define('TEXT_ANCHOR_KEYDENSITY', 'Keyword Density');
  define('TEXT_ANCHOR_CHECK_LINKS', 'Check Links');
  define('TEXT_ANCHOR_HEADER_STATUS', 'Header Status');
  define('TEXT_ANCHOR_SIDS', 'Check SIDS');
  define('TEXT_ANCHOR_SUPPLEMENTAL', 'Supplemental Links');
  ...
  define('TEXT_TOTAL_HARMFUL_FOUND', 'Total Harmful Links Found');
  define('TEXT_TOTAL_HOTLINKS_FOUND', 'Total HotLinks Found');
  ...
  define('TEXT_HARMFUL', 'Google tests its listings for malicious code and, when found, adds a
  warning to the listing which says, <b>"This site may harm your computer."</b> This is a great idea.
  However, if you are not aware that your site has been hacked, it causes two problems. First, you 
  have a hacked site which is a security issue. And, second, your listings in google will have that
  warning, which can do great damage to your sites reputation. This option will allow you to check
  if you have any such listings. If you find such a listing, you should read 
  <a href="http://forums.oscommerce.com/index.php?s=a7aeb559da469fa4cf6fcddfc55f45fe&showtopic=257996"><b>this post</b></a>
  ');  
  
  define('TEXT_HOTLINK', 'HotLinking is the process of another site directly linking to some item
  on your site, usually an image. Whenever anyone visits the other site, the image is loaded from 
  your site, which counts against your bandwidth. There is also the matter of someone taking advanatage 
  of your hard work. Most shop owners put a lot of effort into getting their images the way they
  want them. But then someone comes along and helps themselves to the image. It is just plain stealing.  
  ');  
  
  define('IMAGE_GET_PAGE_RANK', 'Get Page Rank');
  define('IMAGE_CHECK_DENSITY', 'Check Density');
  define('IMAGE_CHECK_HARMFUL', 'Check Harmful Links');
  define('IMAGE_CHECK_HOTLINK', 'Check Hotlink Links');
