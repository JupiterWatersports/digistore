<?php
/*
  $Id: admin_members.php,v 1.13 2005/11/01 01:45:58 hpdl Exp $   
   ============================================  
...
define('ADMIN_EMAIL_TEXT', 'Hi %s,' . "\n\n" . 'Below you will find your temporary password. Follow the link below and once you arrive on the login page click the web address ("jupterkiteboarding.com/store/...") and remove the "login.php" from the address then press enter. '."\n" .' Once you are in hover over the Setup link in the menu and go to Digiadmin Users => Admin Account. '."\n".' Now click Edit and enter the password provided below so you may change your password. '."\n".' This password is only temporary and must be changed in order for you to access the website! Trying to follow the steps above will not work again.' . "\n\n" . 'Website : %s' . "\n" . 'Username: %s' . "\n" . 'Password: %s' . "\n\n" . 'Thanks!' . "\n" . '%s' . "\n\n" . 'This is an automated response, please do not reply!');
