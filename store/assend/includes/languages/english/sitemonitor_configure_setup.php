...
define('TEXT_SITEMONITOR_CONFGIURE_SETUP', 'Please see instructions for Site Monitor in help, befure using this. <br>Use this section to set up the options for SiteMonitor.
...
with quotes and separate them with commas. Selecting the same item twice from the list will remove it.');
