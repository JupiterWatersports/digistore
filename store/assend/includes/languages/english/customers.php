...
define('SELECT_ADDRESS', 'Select the customer address id that you wish to edit: ');
define('DELETE_ADDRESS', 'Delete this customer address');
define('TEXT_DELETE_ADDRESS_INTRO', 'Are you sure you want to delete this address for this customer?');
define('TEXT_DELETE_ADDRESS_ERROR', 'You may not delete the customer&rsquo;s default address!');
?>
