<?php
/*
  $Id: extra_fields.php version 3.0 2011-02-09 $
...
define('ENTRY_ALL_TYPES', 'This field applies to all product types (if no, select from product types listed below): ');
define('ENTRY_CHECK_TYPES', 'Check the boxes for the product types to which this fields applies below. These will be ignored if Applies To All Product Types is set to YES. If a type is checked all subtypes underneath it are also automatically included as using this field. If Applies To All Product Types is set to NO and no types are checked when the field is saved then the Applies To All Product Types setting will be changed to YES.');
...
define('BUTTON_LINK_PTYPE', 'Link Field To Product Type');
...
define('TEXT_APPLIES_TYPES', 'Applies to product types: ');
define('TEXT_ALL', 'all');
define('TEXT_LIMITED', 'limited');
define('ERROR_NOT_TYPE_LINKABLE', 'Only multi-select list fields may be linked to the product type!');
define('ERROR_ALREADY_LINKED', 'Error! This field has already been linked and cannot be linked again!');
define('BUTTON_CREATE_TYPE_LINK', 'Create Link To Product Type');
define('TEXT_CONFIRM_TYPE_LINK', 'Click the button to confirm creation of a link to the product type.');
define('HEADING_UNLINK_TYPE', 'Unlink Field %d From Product Type');
define('ERROR_NOT_TYPE_LINKED', 'This field is not linked to the product type!');
define('TEXT_NUM_TYPE_LINKED', 'Currently %d values from this field are linked to a product type.');
?>
