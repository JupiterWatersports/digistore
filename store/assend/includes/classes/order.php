...
*/
  ...
  class order {
    ...
    function query($order_id) {
      ...
      $order_query = tep_db_query("select customers_id, customers_name, customers_company, customers_street_address, customers_suburb, customers_city, customers_postcode, customers_state, customers_country, customers_telephone, customers_email_address, customers_address_format_id, delivery_name, delivery_company, delivery_street_address, delivery_suburb, delivery_city, delivery_postcode, delivery_state, delivery_country, delivery_address_format_id, billing_name, billing_company, billing_street_address, billing_suburb, billing_city, billing_postcode, billing_state, billing_country, billing_address_format_id, payment_method, cc_type, cc_owner, cc_number, cc_expires, fedex_track_num, ups_track_num, usps_track_num, currency, currency_value, customer_service_id, date_purchased, orders_status, last_modified, ipaddy, payment_signature, send_contract_mail, conditions_of_use_email, ipisp from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
      ...
      // new line for cc_number setting
                          ...
                          'send_contract_mail' => $order['send_contract_mail'],
                          'conditions_of_use_email' => $order['conditions_of_use_email'],
      ...
      $index = 0;
      $orders_products_query = tep_db_query("select * from " . TABLE_ORDERS_PRODUCTS . " op where orders_id = '" . (int)$order_id . "' ORDER BY op.orders_products_id ASC ");
      ...
      for ($i=0, $n=sizeof($products); $i<$n; $i++) {
        ...
        if ($products[$i]['attributes']) {
          ...
          while (list($option, $value) = each($products[$i]['attributes'])) {
            $attributes_query = tep_db_query("select popt.products_options_name, poval.products_options_values_name, pa.options_values_price, pa.options_serial_no, pa.price_prefix, from " . TABLE_PRODUCTS_OPTIONS . " popt, " . TABLE_PRODUCTS_OPTIONS_VALUES . " poval, " . TABLE_PRODUCTS_ATTRIBUTES . " pa where pa.products_id = '" . (int)$products[$i]['id'] . "' and pa.options_id = '" . (int)$option . "' and pa.options_id = popt.products_options_id and pa.options_values_id = '" . (int)$value . "' and pa.options_values_id = poval.products_options_values_id and popt.language_id = '" . (int)$languages_id . "' and poval.language_id = '" . (int)$languages_id . "'");
