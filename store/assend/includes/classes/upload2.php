...
*/
  class uploadTwo {
    var $file, $filename, $destination, $permissions, $extensions, $tmp_filename, $message_location, $medium, $small;
      
    var $counter = 2;  
    function uploadTwo($file = '', $destination = '', $permissions = '777', $extensions = '') {
      $this->set_file($file);
    ...
    function save() {
      ...
      if (move_uploaded_file($this->file['tmp_name'], $this->destination . $this->filename)) {
        ...
        */
        ...
        $maxHeight = array('500', '200');
        $maxWidth = array('500', '200');  
