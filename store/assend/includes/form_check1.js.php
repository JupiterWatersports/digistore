...
if (form.customers_create_type.value != 'none') {
  ...
  if (form.elements['delivery_location'].type != "hidden") {
    if (form.delivery_location.value == '' ) {
      error_message = error_message + "<?php echo '* You must select where the order will be delivered/picked up.\n'; ?>";
      error = 1;
    }
  }
