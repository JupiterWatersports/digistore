    ...
    <div style="display:inline-block; margin-left:30px;">
        ...
        echo '<a class="btn btn-secondary btn-sm" style="padding:7px;">Virtual Store Closed</a>';
           ...
           ?>
            ...
            <a class="btn btn-outline-dark btn-sm" onClick="toggleOverlay2();" style="margin:20px;">Rental Agreement</a>
    </div>
    
    
<div style="display:inline-block; margin-left:0px;">
<?php echo '<a class="btn btn-outline-dark btn-sm" onClick="toggleOverlay();">Consignment Agreement</a>'; ?>
</div>

<div style="display:inline-block; margin-left:20px;">
<a class="btn btn-outline-dark btn-sm" onClick="toggleRepairOverlay();">Repair Agreement</a>
</div>
...
$("#send-tracking").removeClass('disabled');
  		...
  		<div class="form-inline form-group">
               ...
               <div class="col-xs-12">
                   ...
                   <div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" onClick="toggleRepairOverlay();">Repair Agreement</a></button>'; ?></div>
...
?>
  ...
  success :  function(data) {
    ...
    function toggleRepairOverlay () {
        var data = $("#edit_order").serialize();
        $.ajax({
            type : 'POST',
            url  : 'repair-agreement.php?oID=<?php echo $oID; ?>',
            data : data,
            success :  function(data) {
