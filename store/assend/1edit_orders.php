...
<tr><td>&nbsp;</td></tr>
<tr><td>Thank you for your order with us here at Jupiter Kite Paddle Wake. We are happy to assist you with your purchase but first we would need to verify you as a customer. We can do this in several different ways, once we verify you we will not have to do this again in the future.</td></tr>
<tr><td>&nbsp;</td></tr>
...
?>
			...
			<td class="dataTableContent" valign="top">
				<input class="form-control" style="width:140px;" name="<?php echo "update_products[" . $orders_products_id . "][model]"; ?>" size="12" <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>onChange="updateProductsField('update', '<?php echo $orders_products_id; ?>', 'products_model', encodeURIComponent(this.value))"<?php } ?> value="<?php echo $order->products[$i]['model']; ?>"></td>
...
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/checkoutapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Checkout API CALL</a></button>'; ?></div>	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/transactionapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Transaction API CALL</a></button>'; ?></div>	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/rerouteapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Reroute API CALL</a></button>'; ?></div>	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/repriceapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">RePrice API CALL</a></button>'; ?></div>	 

<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/fullfillmentapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">FullFillMent API CALL</a></button>'; ?></div>	 
	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/chargebackapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Chargeback API CALL</a></button>'; ?></div>	 
	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/representmentoutcomeapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Representment Outcome API CALL</a></button>'; ?></div>	 

<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/chargebackstageapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Chargeback Stage API CALL</a></button>'; ?></div>	 
	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/attemptreturnapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Attempt Return API CALL</a></button>'; ?></div>	 
	 
<div class="main form-group"><?php echo '<button class="btn btn-sm btn-info" type="button"><a style="color:#FFF;" target="_NEW" href="https://dev.jupiterkiteboarding.com/store/assend/executereturnapicall.php?oID=' . $_GET['oID'].'" onClick="return confirm(\'Are You Sure?\');">Execute Return API CALL</a></button>'; ?></div>	 
    ...
    elseif ($orders_history['customer_notified'] == '3') {
	 ...
	 elseif ($orders_history['customer_notified'] == '1') {
      ...
      echo tep_image(DIR_WS_ICONS . 'cross.gif', ICON_CROSS) . "</td>\n";
	    ...
	    echo '    <td class="align-middle" align="left">' . $orders_status_array[$orders_history['orders_status_id']] . '</td>' . "\n";
