...
/*  (delete this line if you need the the function tep_rand)
//  If Oscommerce MS2 or later -- this should already existing in the general.php.
//  If so, do not remove the remark/comment symbol.
//  If it does not exist please remove the remark/comment symbol.
//
////
