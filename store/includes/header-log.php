...
<div id="log">
<ul>
	<li id="mycart"><a href="http://jupiterkiteboarding.com/store/shopping-cart">My Cart</a></li>
    <li id="login"><a href="https://www.jupiterkiteboarding.com/store/login">Login</a></li>
    
    <li id="logoff"><a href="https://www.jupiterkiteboarding.com/store/logoff">Log Off</a></li>
    <li id="newproducts"><a href="http://jupiterkiteboarding.com/store/products-new">New Products</a></li>
    
    <li id="reviews"><a href="http://jupiterkiteboarding.com/store/reviews">Reviews</a></li>
</ul>
</div>
<div id="searchbox1">
