...
==========================================================
  ...
  Google Analytics Beta modification v 2.1.1 2008/04/28 by:
  Tomas Hesseling (www.boxershortz.nl) &
  Mathieu Burgerhout (www.seo-for-osc.com)
  Phoenix Medien (www.phoenix-medien.de)
  Update by sunrise99 (www.sunrisebook.com) on 2009/11/17
==========================================================    
--------------------------------------------------
...
// Get products info for Analytics "Item lines"
    ...
    while ($items = tep_db_fetch_array($items_query)) {
      ...
      $item_string .=  "pageTracker._addItem(\n\"" . $order_id . "\",\"" . $items['products_model'] . "\",\"" .$items['products_name'] . "\",\"" . $category['categories_name'] . "\",\"" . number_format($items['final_price'], 2, '.', '') . "\",\"" . $items['products_quantity'] . "\");\n";
    }
