...
<?php
    ...
    while ($listing = tep_db_fetch_array($listing_query)) {
    	...
    	if (tep_not_null($listing['specials_new_products_price'])) {
           ...
           $buy_button ='<form name="buy_now_' . $listing['products_id'] . '" method="post" action="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now', 'NONSSL') . '"><input type="hidden" name="products_id" value="' . $listing['products_id'] . '" >' . tep_mobile_button(IMAGE_BUTTON_BUY_NOW . $listing_values['products_name']) . '</form> ';
