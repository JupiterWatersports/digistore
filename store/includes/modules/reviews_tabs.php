...
<div style="float:left; width:100%; margin-top:15px;">
	<div class="leftfloat">
    <?php echo $reviews['customers_name']; ?>
    <?php echo '<div style="display: inline-block;"><span style="vertical-align: middle; height: 25px; display: inline-block;">' .  tep_image(DIR_WS_IMAGES . 'stars_' . $reviews['reviews_rating'] . '.gif') .'</span><span style="display:inline-block; vertical-align:middle;">'. sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating']) . '</span></div>'; ?>
	<div class="left-align" style="font-size:12px;"><?php echo tep_date_short($reviews['date_added']); ?></div>
	</div>
	<div class="clear spacer"></div>
	<?php echo '<div class="review-text" style="margin-top:10px; margin-bottom:35px;">'. tep_output_string_protected($reviews['reviews_text']).'</div>';?>
	<div class="clear"></div>  
    </div>                                           
...
<style>
.leftfloat img{margin-bottom:-10px; width:auto; height:25px;}
