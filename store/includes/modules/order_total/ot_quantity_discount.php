  ...
  class ot_quantity_discount {
   ...
   function pre_confirmation_check($order_total) {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ORDER_TOTAL_QUANTITY_DISCOUNT_SORT_ORDER', '2', 'Sort order of display.', '6', '2', now())");
