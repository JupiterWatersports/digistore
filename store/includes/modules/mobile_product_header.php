...
echo '<form name="buy_now" method="post" action="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=buy_now', 'NONSSL') . '">'
?>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	  <tr>
<?php
 echo '<td><input type="hidden" name="products_id" value="' . $product_info['products_id'] . '">' . tep_mobile_button("Add To Cart") . '</td>';
?>		
	  </tr>
	  <tr>
