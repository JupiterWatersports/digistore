...
var phpHelpUrl="<?php echo tep_href_link(FILENAME_PRODUCT_INFO,'products_id=','NONSSL',false,false);?>";
...
<?php
  ...
  $info_box_contents[] = array('form' => tep_draw_form('quick_find', tep_href_link(FILENAME_ADVANCED_SEARCH_RESULT, '', 'NONSSL', false), 'get'),
                               'align' => 'center',
                               'text' => '<div id="content" onclick="hideSuggestions();"><div id="ie_fix">'.tep_draw_input_field('keywords', '', 'size="10" id="keyword" maxlength="60" onkeyup = "handleKeyUp(event)" style="width: ' . (BOX_WIDTH-30) . 'px"') .'</div>'.'<div id="scroll"><div id="suggest"></div></div></div>'. '&nbsp;' . tep_hide_session_id() . tep_image_submit('button_quick_find.gif', BOX_HEADING_SEARCH). '<br />' . BOX_SEARCH_TEXT . '<br /><a href="' . tep_href_link(FILENAME_ADVANCED_SEARCH) . '"><b>' . BOX_SEARCH_ADVANCED_SEARCH . '</b></a>'                               
                               );
