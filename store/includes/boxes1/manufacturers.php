...
$link = preg_replace('|/store/|','',$_SERVER['PHP_SELF']);
      $info_box_contents = array();
      $info_box_contents[] = array('form' => tep_draw_form('manufacturers', tep_href_link('index.php', '', 'NONSSL', false), 'get'),
                                   'text' => tep_draw_pull_down_menu('mp_id', $manufacturers_array, (isset($HTTP_GET_VARS['mp_id']) ? $HTTP_GET_VARS['mp_id'] : ''), 'onChange="this.form.submit();" size="' . MAX_MANUFACTURERS_LIST . '" style="width: 100%"') . tep_hide_session_id());
    }
