...
define('ENTRY_STATE_TEXT', '* (Seleccione el país primer)');

define('ENTRY_COUNTRY_TEXT', '* (Auto-actualización Dropdown de la voluntad del estado cuando está cambiado)');
...
define('HEADER_TITLE_PRODUCTS_DESC', 'Descripción de productos:');
...
define('FOOTER_MY_ACCOUNT','Mi Cuenta');

define('FOOTER_SEARCH','B&uacute;squeda Avanzada');

define('FOOTER_PRODUCTS_NEW','Nuevos productos');

define('FOOTER_SPECIALS','Ofertas');

define('FOOTER_CONTACT','Contactenos');

define('FOOTER_LOG_OFF','Salir');

define('FOOTER_ABOUT_US','Sobre nosotros');
...
define('BOX_HEADING_CATEGORIES', 'Hojee el almacén');
...
define('VIEW_BASKET', 'Ver la cesta');

define('CHECKOUT', 'Realizar pedido');

define('BASKET_EMPTY', 'No hay a la cesta');
...
define('FORM_REQUIRED_INFORMATION', '<font color="red">*</font>Dato Obligatorio');
...
define('IMAGE_BUTTON_NEXT_PROD', 'Producto siguiente');

define('IMAGE_BUTTON_PREV_PROD', 'Producto anterior');

define('IMAGE_BUTTON_PRODUCT_PRINT', 'Producto de la impresión');
...
define('BOX_INFORMATION_SITEMAP','Mapa de sitio'); 

//Manufacture box

define('TEXT_MAN_HOME','Web site de los fabricantes');

define('TEXT_MAN_SHOWALL','Demuestre todos los productos de Manufacturer');



//tracking 

define('BOX_INFORMATION_ABOUT', 'Sobre nosotros');

define('BOX_HEADING_CLICKHERE','Chasque aquí');

// bof information

define('SHOPINFO_PRINT_LINK', 'Imprimir la pagina');

// eof information



define('TEXT_BEFORE_DOWN_FOR_MAINTENANCE', 'AVISO: Web site abajo para el mantenimiento

 - plazo  (mm/dd/yy) (hh-hh): ');

define('TEXT_ADMIN_DOWN_FOR_MAINTENANCE', 'AVISO: el Web site está actualmente abajo para el mantenimiento al público');



// Start recently viewed

define('BOX_HEADING_RECENTLY_VIEWED','&nbsp;Visto recientemente');

define('TEXT_LINK_RECENTLY_VIEWED','Productos recientemente vistos');

define('TEXT_SHOW_MORE', ' ... [Más]');
...
define('MATC_CONDITION_AGREEMENT', '<span style="color:#999; font-size:11px; font-family:tahoma;">He leído <a href="%s" target="_blank"><strong><u>Términos &amp; Condiciones</u></strong></a> y convengo ellos:</span> ');

define('MATC_HEADING_CONDITIONS', 'Acuerdo de las condiciones');

define('MATC_ERROR', 'Usted debe acordar nuestras condiciones para continuar.');
...
define('IMAGE_BUTTON_OUT_OF_STOCK', 'Ninguna acción');
