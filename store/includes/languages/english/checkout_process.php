...
// Email style
define('STORE_LOGO', 'jkb-logo-black.png'); // Your shop logo (location: /catalog/images).
...
define('EMAIL_MESSAGE_GREETING', '<br/>Thank you for shopping with us today.<br /><br />Your order should be processed and ready to be shipped within 1-2 business days. In some cases, we may need to contact you for further verification. To prevent any delays please make sure that your billing address matches with the information provided for your credit card. At Jupiter Kiteboarding we take these measures to protect our customers from debit/credit card fraud and identity theft.<br /><br />Please find the details of your order below:'); 
