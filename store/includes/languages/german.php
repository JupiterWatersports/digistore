...
define('ENTRY_STATE_TEXT', '* (Wählen Sie Land erstes vor)');

define('ENTRY_COUNTRY_TEXT', '* (Zustanddrop-down-Willec$selbst-update, wenn Sie geändert werden)');
...
define('HEADER_TITLE_PRODUCTS_DESC', 'Produkt-Beschreibung:');
...
define('FOOTER_MY_ACCOUNT','Ihr Konto');

define('FOOTER_SEARCH','Schnellsuche');

define('FOOTER_PRODUCTS_NEW','Neue Produkte');

define('FOOTER_SPECIALS','Angebote');

define('FOOTER_CONTACT','Kontakt');

define('FOOTER_LOG_OFF','Abmelden');
...
define('BOX_HEADING_CATEGORIES', 'Grasen Sie Speicher');
...
define('VIEW_BASKET', 'Warenkorb');

define('CHECKOUT', 'Kasse');

define('BASKET_EMPTY', 'Keine Produkte');
...
define('FORM_REQUIRED_INFORMATION', '<font color="red">*</font> Notwendige Eingabe');
...
define('IMAGE_BUTTON_DETAILS', 'Bearbeiten');
...
define('IMAGE_BUTTON_NEXT_PROD', 'Folgendes Produkt');

define('IMAGE_BUTTON_PREV_PROD', 'Vorhergehendes Produkt');

define('IMAGE_BUTTON_PRODUCT_PRINT', 'Druck-Produkt');
...
define('BOX_INFORMATION_SITEMAP','Aufstellungsort-Diagramm'); 

//Manufacture box

define('TEXT_MAN_HOME','Herstellerweb site');

define('TEXT_MAN_SHOWALL','Zeigen Sie alle Produkte durch Manufacturer');



//tracking 

define('BOX_INFORMATION_ABOUT', 'Über uns');

define('BOX_HEADING_CLICKHERE','Klicken Sie hier');

// bof information

define('SHOPINFO_PRINT_LINK', 'Druckversion');

// eof information

define('TEXT_BEFORE_DOWN_FOR_MAINTENANCE', 'NACHRICHT: Web site unten fÃ¼r Wartung - Zeitraum

 (mm/dd/yy) (hh-hh): ');

define('TEXT_ADMIN_DOWN_FOR_MAINTENANCE', 'NACHRICHT: die Web site ist z.Z. unten fÃ¼r Wartung zur Ã–ffentlichkeit');
...
define('TEXT_SHOW_MORE', ' ... [Mehr]');

// End recently viewed

//-----   BEGINNING OF ADDITION: MATC   -----//

define('MATC_CONDITION_AGREEMENT', '<span style="color:#999; font-size:11px; font-family:tahoma;">Ich habe die <a href="%s" target="_blank"><strong><u>AGB</u></strong></a> gelesen und erkläre mich damit einverstanden:</span> ');

define('MATC_HEADING_CONDITIONS', 'Unsere AGB und Ihr Widerrufsrecht');
...
define('IMAGE_BUTTON_OUT_OF_STOCK', 'Kein Vorrat');
