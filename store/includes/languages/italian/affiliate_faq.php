...
define('NAVBAR_TITLE', 'FAQ del Programma di Affiliazione');
define('HEADING_TITLE', 'Programma di affiliazione - Frequently Asked Questions');

define('TEXT_INFORMATION', '' . STORE_NAME . ' ha compilato questa lista di domande e risposte di modo che tu possa trovare facilmente le risposte che cerchi. Diversamente non esitare a contattarci.<br />
 Per info <a href="' . tep_href_link(FILENAME_AFFILIATE_CONTACT). '">' . BOX_AFFILIATE_CONTACT . '</a>.<br />
<ul>
