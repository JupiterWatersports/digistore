...
define('NAVBAR_TITLE', 'Programma di affiliazione');
define('HEADING_TITLE', 'programma di affiliazione');

define('HEADING_AFFILIATE_PROGRAM_TITLE', '' . STORE_NAME . ' Termini di affiliazione');
 ...
 <table width="98%" border="0" cellspacing="0" cellpadding="4">
  <tr>
   <td bgcolor="#FFFFFF">
		...
		Iscrivendoti al programma affermi di aver letto con attenzione le condizioni di affiliazione</span>
		</P>
