...
define('HEADING_IPRECORDED_1','ANMERKUNG! Das untengenannte IP und das ISP ist zu den Sicherheitszwecken notiert worden.');
define('YOUR_IP_IPRECORDED', 'IP Adresse');
