...
<?php echo tep_draw_input_field('state') . '&nbsp;' . (tep_not_null(ENTRY_STATE_TEXT) ? '*' . '</span>': ''); ?>
</div>
...
<?php echo tep_get_country_list('country') . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '*'.'</span>': ''); ?>
</div>
</div>
...
?>        
<button style="float:left" class="button-blue-small">Continue</button></div>
</div> 
</form>
<div class="clear spacer-tall"></div>
<?php 
