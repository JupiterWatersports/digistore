...
<div id="top">
<div id="logo">
<img src="../../images/jup_kitepaddlewake.png" width="259" height="130" alt="jupiter kite-paddele-wake"/>
</div>
  
<div id="number">
<img src="../../number-404.png" width="324" height="115">/>
</div>
  
<div id="log">
<ul>
	<li id="mycart"><a href="http://jupiterkiteboarding.com/store/shopping-cart.php">My Cart</a></li>
    <li id="login"><a href="https://www.jupiterkiteboarding.com/store/login.php">Login</a></li>
    
    <li id="logoff"><a href="https://www.jupiterkiteboarding.com/store/logoff.php">Log Off</a></li>
    <li id="newproducts"><a href="http://jupiterkiteboarding.com/store/products-new.php">New Products</a></li>
    
    <li id="reviews"><a href="http://jupiterkiteboarding.com/store/reviews.php">Reviews</a></li>
</ul>
</div>
<div id="searchbox1">
<script src="store/ext/jquery/jquery.js" type="text/javascript"></script>
<script type="text/javascript" src="store/ext/jquery/ui/home_controller.js"></script>
<link rel="stylesheet" type="text/css" href="store/live.css" />    <!-- search_box_oef //-->
<script type="text/javascript">jQuery.noConflict();</script>  
                       
<div id="form">
<form name="quick_find" action="http://jupiterkiteboarding.com/store/advanced_search_result.php" method="get" id="quickfind">
<input style="width:140px;" type="text" id="keywords" name="keywords" value="Search Here..." onClick="clearInput(this)"><input type="submit" style="display:none"></form>
</div>
