...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr class="header2">
    <td height="65" valign="middle"><img src="../images/paddlelogo1.jpg" width="310" height="112"></td>
<td><a href="http://jupiterkiteboarding.com/store/redirect.php?action=banner&amp;goto=20" target="_blank"><img src="/store/images/banners/products_shoppingcart.gif" border="0" alt="New Products" title=" New Products " width="718" height="112"></a></td>  </tr>
</table>
...
<tr class="headerCrumb">
    <td height="28" class="headerCrumb" valign="middle" style="padding:0px 10px 0px 2px">&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://jupiterkiteboarding.com/paddleboarding.php" class="headerCrumb">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://jupiterkiteboarding.com/weather_paddle.php" class="headerCrumb">Weather</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="paddleboardingrequiredsafetyequipment.php" class="headerCrumb">Coast Guard Regulations</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="shipping2_paddle.php" class="headerCrumb">Free Shipping On Orders Over $100</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="gallery_paddle.php" class="headerCrumb">Gallery</a></td>
<td  align="right" style="padding:0px 11px 0px 10px" class="headerCrumb" valign="middle">
					...
					<form name="quick_find" action="http://jupiterkiteboarding.com/store/advanced_search_result.php" method="get"><input type="hidden" name="search_in_description" value="1"><input type="text" name="keywords" size="10" maxlength="30" style="width: 135px; height:20px; font-size:12px;" onClick="this.value=''"><td  style="vertical-align: top; padding:0px 0px 0px 10px;"><input type="image" src="store/includes/languages/english/images/buttons/button_quick_find.gif" border="0" alt="Quick Find" title=" Quick Find "></a></form></td></tr></table>
  </tr>
</table>
