...
#menu p, #menu h2, #menu span, #menu ul li {
	font-family:Tahoma, Geneva, sans-serif;
	line-height:21px;
	font-size:12px;
	text-align:left;
...
<div id="top">
<div id="logo"><img src="images/jup_kitepaddlewake.png" width="259px" height="130px" alt="jupiter kite-paddele-wake"/></div>
<div id="number"><img src="images/number.png" width="310px" height="100px" class="c1" alt="number"/></div>
  
<div id="log">
<ul>
	<li id="mycart"><a href="http://www.jupiterkiteboarding.com/store/shopping_cart.php" rel="nofollow">My Cart</a></li>
    <div id="myaccount">
    ...
    <li><a href="http://www.jupiterkiteboarding.com/store/logoff.php">Log Off</a></li>
</ul> 
</div> 
</div>
</li>
</div
<li id="newproducts"><a href="http://www.jupiterkiteboarding.com/store/products_new.php" rel="nofollow">New Products</a></li>
<li id="reviews"><a href="http://www.jupiterkiteboarding.com/store/reviews.php"  rel="nofollow">Reviews</a></li>
</ul>
</div>

<div id="searchbox1">
<div id="form">
<form name="quick_find" action="http://jupiterkiteboarding.com/store/advanced_search_result.php" method="get" id="quickfind"><input class="c2" type="text" id="keywords" name="keywords" value="Search Here..." onClick="clearInput(this)"/><input type="submit" class="c3" /></form>
</div>
